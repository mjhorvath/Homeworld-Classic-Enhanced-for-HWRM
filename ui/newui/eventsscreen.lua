...
EventsScreen = {
	...
	eventOpaque = 0,
	onShow = "UI_SetButtonPressed('NewTaskbar', 'btnEvents', 1); UI_HideScreen('UnitCapInfoPopup'); UI_HideScreen('BuildQueueMenu'); UI_HideScreen('BountiesScreen'); UI_HideScreen('BentusiScreen'); UI_HideScreen('ProgressScreen'); UI_HideScreen('MusicScreen'); UI_HideScreen('RulesScreen');",
	onHide = "UI_SetButtonPressed('NewTaskbar', 'btnEvents', 0);",
