    ...
    for i in BIGLIST:
        ...
        if num_bits > 0:
            for k in range(num_digi):
                ...
                new_i = copy.deepcopy(i)
                # not all ships/subsystems need the suffix
                # need to fix the ones that don't need the suffix by hand until I am able to fix the spreadsheet and this program
