...
setTargetBox(NewShipType, 0, -0.1,-0.45,-0.8, 0.1,0.5,0.6)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=70
NewShipType.layoutBoundY=60
NewShipType.layoutBoundZ=140
...
holdCanAttackFams = getShipStr(NewShipType, "CanAttackFams", "Corvette_hw1, Corvette, Fighter_hw1, Fighter, Utility,,,,,, Frigate, SmallCapitalShip, BigCapitalShip, Mothership")
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1.5,holdCanAttackFams,"Frontal",
{Fighter="Frontal"},
{Fighter_hw1="Frontal"},
{Corvette="Frontal"},
...
addCustomCode(NewShipType,"data:ship/Tai_MissileDestroyer/Tai_MissileDestroyer.lua","","","Update_Tai_MissileDestroyer","","Tai_MissileDestroyer",4)
LoadSharedModel(NewShipType,"Tai_MissileDestroyer");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncher","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncher","Weapon_Gun1","Weapon_Gun1");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncher","Weapon_Gun2","Weapon_Gun2");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncher","Weapon_Gun3","Weapon_Gun3");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncherVolley","Weapon_GunV0","Weapon_Gun0v");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncherVolley","Weapon_GunV1","Weapon_Gun1v");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncherVolley","Weapon_GunV2","Weapon_Gun2v");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerLauncherVolley","Weapon_GunV3","Weapon_Gun3v");
addShield(NewShipType,"EMP",1000,20);
StartShipHardPointConfig(NewShipType,"Engine","Hardpoint_Engine","System","Innate","Damageable","Tai_MissileDestroyerEngine","","","","","","","","");
SpawnSalvageOnDeath(NewShipType,"Slv_Chunk_Lrg03",1, 0.45,0,0,0, 0,0,0,50,0,0,0,200,0,0,0,50,0,0,0,50);
SpawnSalvageOnDeath(NewShipType,"Slv_Chunk_Lrg05",1, 0.2,0,0,0, 25,10,-100,30,35,75,62,75,0,0,0,80,0,0,0,50);
