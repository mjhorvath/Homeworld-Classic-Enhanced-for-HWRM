...
NewShipType.displayedName="$1571"
NewShipType.sobDescription="$1571"
...
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",1,1,20,50,0,1);
end
addAbility(NewShipType,"MoveCommand",1,1);
addAbility(NewShipType,"CanDock",1,0);
addAbility(NewShipType,"CanBeCaptured",45,0.1);
...
setEngineBurn(NewShipType,20,0.5,0.6,16,0.1,0.1,0.05,20);
