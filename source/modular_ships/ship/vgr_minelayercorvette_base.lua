...
NewShipType.displayedName="$1614"
NewShipType.sobDescription="$1615"
...
setTacticsMults(NewShipType, "WEAPONDAMAGE", 1.0, 1.0, 1.0)
...
NewShipType.thrusterMaxSpeed=233
NewShipType.mainEngineMaxSpeed=233
...
setSupplyValue(NewShipType, "MinelayerCorvette", 1.0)
...
addAbility(NewShipType,"CanAttack",1,1,1,0,0.35,1,"Munition, BigCapitalShip, SmallCapitalShip, Frigate, Corvette, Corvette_hw1, Fighter, Fighter_hw1, Mothership","VCorvette_vs_Frigate_AR",
...
LoadSharedModel(NewShipType,"Vgr_MinelayerCorvette");
StartShipWeaponConfig(NewShipType,"Vgr_MineLayer","Weapon_Mine","");
StartShipWeaponConfig(NewShipType,"Vgr_MinelayerCannon","Weapon_ClearMine","Weapon_ClearMine");
StartShipWeaponConfig(NewShipType,"Vgr_MineSweeperBurstCannon","Weapon_ClearMine","Weapon_ClearMine");
...
setEngineTrail(NewShipType,0,5,"trail_ribbon.tga",0.005,0.1,0.025,3);
