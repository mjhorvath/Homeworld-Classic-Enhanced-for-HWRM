...
NewShipType.displayedName="$1514"
NewShipType.sobDescription="$1515"
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Mothership, Utility, Corvette, Corvette_hw1, Fighter, Fighter_hw1","JustShoot");
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
NewShipType.disableOnRaceChange=0
LoadSharedModel(NewShipType,"Hgn_IonTurret");
StartShipHardPointConfig(NewShipType,"Weapon_Top","Hardpoint_Top","Weapon","Innate","Ship","Hgn_IonCannonTurret","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_Bottom","Hardpoint_Bottom","Weapon","Innate","Ship","Hgn_IonCannonTurret","","","","","","","","");
