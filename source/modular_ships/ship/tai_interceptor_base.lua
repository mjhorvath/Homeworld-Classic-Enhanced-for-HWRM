...
LoadSharedModel(NewShipType,"Tai_Interceptor");
StartShipWeaponConfig(NewShipType,"Tai_Interceptor","Weapon_Gun1","Weapon_Gun1");
...
setEngineTrail(NewShipType,0,3.1,"trail_ribbon.tga",0.01,0.5,0.025,1.5);
