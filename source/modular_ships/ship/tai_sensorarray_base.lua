...
NewShipType.displayedName="$10058"
NewShipType.sobDescription="$10059"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 7000)
...
setTargetBox(NewShipType, 0, -0.73,-0.5,-0.1, 0.3,0.6,0.8)
...
setSupplyValue(NewShipType, "SensorArray", 1.0)
...
NewShipType.secSensorRange = getShipNum(NewShipType, "secSensorRange", 17000)
if (getShipNum(NewShipType, "canPing", 1) > 0) then
...
addCustomCode(NewShipType,"data:Ship/Tai_SensorArray/Tai_SensorArray.lua","","","Update_Tai_SensorArray","","Tai_SensorArray",10)
LoadSharedModel(NewShipType,"Tai_SensorArray");
...
NewShipType.explosiveScuttleDamageOnDeath=263
NewShipType.maxFalloffForce=500*10
NewShipType.explosiveDamageOnDeath=53
