...
NewShipType.displayedName="$1630"
NewShipType.sobDescription="$1631"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 65000)
...
setTargetBox(NewShipType, 0, 0.1,-0.3,-0.9, 0.41,0.6,0.8)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=100
NewShipType.layoutBoundY=125
...
addCustomCode(NewShipType,"data:Ship/Vgr_Carrier/Vgr_Carrier.lua","","Create_Vgr_Carrier","Update_Vgr_Carrier","","Vgr_Carrier",4)
LoadSharedModel(NewShipType,"vgr_carrier");
StartShipWeaponConfig(NewShipType,"Hgn_MSHullDefenseGun2","Weapon_1HullDefense","");
StartShipWeaponConfig(NewShipType,"Hgn_MSHullDefenseGun2","Weapon_2HullDefense","");
StartShipWeaponConfig(NewShipType,"Hgn_MSHullDefenseGun2","Weapon_3HullDefense","");
StartShipWeaponConfig(NewShipType,"Hgn_MSHullDefenseGun2","Weapon_4HullDefense","");
...
loadShipPatchList(NewShipType,"data:sound/sfx/ship/",0,"Vaygr/Carrier/Engines/VDestroyerEng","",1,"Vaygr/Carrier/Ambience/VDestroyerAmb","",3,"Megaliths/RandomEmit/HANGAR_EMITTERS","HardPoint_Production1_Position");
...
loadLatchPointList(NewShipType,"CapCap","CapturePoint0","CapturePoint2","CapturePoint4","CapturePoint5");
loadLatchPointList(NewShipType,"RepCap","RepairPoint1","RepairPoint2","RepairPoint3","RepairPoint4","RepairPoint5");					 
...
NewShipType.explosiveScuttleDamageOnDeath=1265
NewShipType.maxFalloffForce=500*10
NewShipType.explosiveDamageOnDeath=253
