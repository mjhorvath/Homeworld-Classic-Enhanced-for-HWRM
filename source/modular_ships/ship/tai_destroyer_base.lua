...
addCustomCode(NewShipType,"data:Ship/Tai_Destroyer/Tai_Destroyer.lua","Load_Tai_Destroyer","Create_Tai_Destroyer","Update_Tai_Destroyer","","Tai_Destroyer",10)
LoadSharedModel(NewShipType,"Tai_Destroyer");
StartShipHardPointConfig(NewShipType,"Weapon_Gun0","Hardpoint_Gun0","Weapon","Innate","Ship","Tai_DestroyerGun","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_Gun2","Hardpoint_Gun2","Weapon","Innate","Ship","Tai_DestroyerGun","","","","","","","","");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerIon","Weapon_Gun4","Weapon_Gun4");
StartShipWeaponConfig(NewShipType,"Tai_DestroyerIon","Weapon_Gun5","Weapon_Gun5");
--StartShipWeaponConfig(NewShipType,"Tai_DestroyerGun","Weapon_Gun0","Weapon_Gun0");
--StartShipWeaponConfig(NewShipType,"Tai_DestroyerGun","Weapon_Gun2","Weapon_Gun2");
addShield(NewShipType,"EMP",1000,20);
StartShipHardPointConfig(NewShipType,"Engine","Hardpoint_Engine","System","Innate","Damageable","Tai_DestroyerEngine","","","","","","","","");
...
SpawnSalvageOnDeath(NewShipType,"Slv_Chunk_Lrg01",1, 0.1,0,0,0, 60,30,150,25,35,125,65,75,0,0,0,60,0,0,0,50);
