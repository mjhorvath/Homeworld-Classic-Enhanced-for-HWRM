resourceModule = ""
capshipbuildModule = "hw1_production_capital"
...
NewShipType.prmSensorRange = getShipNum(NewShipType, "prmSensorRange", 6500)
NewShipType.secSensorRange = getShipNum(NewShipType, "secSensorRange", 8500)
...
addAbility(NewShipType,"CanBuildShips",1,"Fighter_Kus, Corvette_Kus, Frigate_Kus, SuperCap_Kus, Resource_Kus, NonCombat_Kus","Fighter, Corvette, Frigate, Capital, Resource, NonCombat");
addAbility(NewShipType,"CanBeCaptured",300,0.5);
addAbility(NewShipType,"CanBeRepaired");
addCustomCode(NewShipType,"data:Ship/Kus_Mothership/Kus_Mothership.lua","Load_Kus_Mothership","Create_Kus_Mothership","Update_Kus_Mothership","Destroy_Kus_Mothership","Kus_Mothership",2)
LoadSharedModel(NewShipType,"Kus_Mothership");
...
StartShipHardPointConfig(NewShipType,"CapShip Production","Hardpoint_Resource","System","Production","Indestructible","",capshipbuildModule,"","","","","","","");
...
loadShipPatchList(NewShipType,"data:sound/sfx/ship/",0,"Hiigaran/MegaShip/Engines/HMothershipEng","",1,"Kushan/MegaShip/Ambience/MotherShip","",3,"Megaliths/RandomEmit/HANGAR_EMITTERS","marker3");
