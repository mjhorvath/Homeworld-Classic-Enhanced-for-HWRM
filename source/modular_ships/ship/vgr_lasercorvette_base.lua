...
NewShipType.displayedName="$1610"
NewShipType.sobDescription="$1611"
...
setTacticsMults(NewShipType, "ROTATION", 0.90, 1.10, 1.0)
...
setTacticsMults(NewShipType, "BULLETSPEED", 1.05, 1.0, 1.0)
setTacticsMults(NewShipType, "DAMAGEAPPLIED", 1.15, 1.0, 1.0)
setTacticsMults(NewShipType, "FIRERATE", 1.0, 1.25, 1.0)
setSpeedvsAccuracyApplied(NewShipType, 50.0, 5.0, 180, 1.0, 250, 1.0, 270, 1.25, 312, 0.90, 319, 0.80)
...
NewShipType.CombatFamily="Corvette_Laser"
...
NewShipType.antiFrigateValue=2.5
NewShipType.totalValue=2.5
NewShipType.buildCost=650
...
addAbility(NewShipType,"CanAttack",1,2,1,0,0.35,0.95,"Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Utility, Resource,,,,,, Fighter, Fighter_hw1, Corvette, Corvette_hw1","VCorvette_vs_Corvette_AR",
{Fighter="VCorvette_vs_Corvette_AR"},
{Fighter_hw1="VCorvette_vs_Corvette_AR"},
{Corvette_hw1="VCorvette_vs_Corvette_AR"},
{Frigate="VCorvette_vs_Frigate_AR"},
{Mothership="VCorvette_vs_CapShip_AR"},
{SmallCapitalShip="VCorvette_vs_SmallCapShip_AR"},
{BigCapitalShip="VCorvette_vs_CapShip_AR"},
...
addCustomCode(NewShipType, "data:ship/Vgr_LaserCorvette/Vgr_LaserCorvette.lua", "", "", "Update_Vgr_Laser_Corvette", "", "Vgr_LaserCorvette", 1)
LoadSharedModel(NewShipType,"Vgr_LaserCorvette");
StartShipWeaponConfig(NewShipType,"Vgr_Laser","Weapon_Laser","Fire_L");
