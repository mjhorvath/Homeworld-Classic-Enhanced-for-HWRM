...
NewShipType.displayedName="$10032"
NewShipType.sobDescription="$10033"
...
setTargetBox(NewShipType, 0, -0.3,-0.7,-0.94, 0.3,0.24,0.9)
...
addMagneticField(NewShipType,"MagneticField",1000,100,"defenseField_generic",15,"defenseField_generic",100,"plasma_hit_spray_MagneticField","defensefield_sphere_spray_TFF");
addAbility(NewShipType,"DefenseFieldShieldAbility",0,1200,0,0);
AddShipMultiplier(NewShipType,"WeaponDamage","EnemyShipsWithinRadius","Linear",0.93,0.93,1200);
AddShipMultiplier(NewShipType,"WeaponAccuracy","EnemyShipsWithinRadius","Linear",0.93,0.93,1200);
addCustomCode(NewShipType,"data:ship/Tai_FieldFrigate/Tai_FieldFrigate.lua","","","Update_Tai_FieldFrigate","","Tai_FieldFrigate",4)
LoadSharedModel(NewShipType,"Tai_FieldFrigate");
