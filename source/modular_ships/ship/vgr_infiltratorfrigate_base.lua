...
addCustomCode(NewShipType,"data:ship/Vgr_InfiltratorFrigate/Vgr_InfiltratorFrigate.lua","","","Update_Vgr_InfiltratorFrigate","","Vgr_InfiltratorFrigate",4)
LoadSharedModel(NewShipType,"Vgr_InfiltratorFrigate");
