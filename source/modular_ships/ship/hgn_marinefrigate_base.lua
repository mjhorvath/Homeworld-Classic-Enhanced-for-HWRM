...
NewShipType.displayedName="$1528"
NewShipType.sobDescription="$1529"
...
setTargetBox(NewShipType, 0, -0.5,-0.65,-0.9, 0.5,0.45,0.6)
...
addAbility(NewShipType,"CaptureCommand",1,10);
AddShipMultiplier(NewSubSystemType, "Capture", "EnemyShipsWithinRadius", "Linear", 1.01, 1.01, 1000)
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",0,1,200,450,0,3);
end
addAbility(NewShipType,"CanAttack",1,1,0,1,0.35,1.5,"Capturer, Corvette, Corvette_hw1, Fighter, Fighter_hw1, SmallCapitalShip, BigCapitalShip, Mothership","frontal_Frigate",
...
addCustomCode(NewShipType,"data:ship/Hgn_MarineFrigate/Hgn_MarineFrigate.lua","","","Update_Hgn_MarineFrigate","","Hgn_MarineFrigate",4)
LoadSharedModel(NewShipType,"Hgn_MarineFrigate");
StartShipHardPointConfig(NewShipType,"Weapon_Top","Hardpoint_Top","Weapon","Innate","Ship","Hgn_VulcanKineticTurretHeavy","","","","","","","","");
--StartShipWeaponConfig(NewShipType,"Hgn_VulcanKineticTurretHeavy","Weapon_Top","Weapon_Top");
