...
NewShipType.sobDescription="$10001"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 60)	
...
setTacticsMults(NewShipType, "MAXSPEED", 1.0, 1.05, 1.0)
...
setSpeedvsAccuracyApplied(NewShipType, 100.0, 5.0, 250, 1.0, 431, 1.2, 490, 1.0, 535, 0.95)
...
NewShipType.mainEngineMaxSpeed=460
NewShipType.rotationMaxSpeed=125
NewShipType.thrusterAccelTime=2.3
NewShipType.thrusterBrakeTime=1.1
NewShipType.mainEngineAccelTime=2.3
NewShipType.mainEngineBrakeTime=1.1
...
NewShipType.mirrorAboveManeuver=" ImmelMann, ImmelMann_speedy, OneEightyDegRightTurn, OneEightyDegLeftTurn, None,None"
NewShipType.mirrorBelowManeuver=" Split_S, Split_S_speedy, OneEightyDegRightTurn, OneEightyDegLeftTurn, None,None"
NewShipType.specialTurnLeftManeuver="EmergencyLeftTurn, NinetyDegLeftTurn, None,None"
NewShipType.specialTurnRightManeuver="EmergencyRightTurn, NinetyDegRightTurn, None, None"
...
NewShipType.CombatFamily="Fighter_Scout"
...
NewShipType.buildTime=8
NewShipType.buildPriorityOrder=10
NewShipType.retaliationRange=4800
NewShipType.retaliationDistanceFromGoal=160
NewShipType.visualRange=1500
NewShipType.prmSensorRange = getShipNum(NewShipType, "prmSensorRange", 6000)
NewShipType.secSensorRange = getShipNum(NewShipType, "secSensorRange", 7000)
...
addAbility(NewShipType,"CanAttack",1,0,1,500,0.35,1,"Fighter_hw1, Fighter, Swarmer, Corvette_hw1, Corvette, Capturer, Frigate, Utility, Resource,,,, SmallCapitalShip, BigCapitalShip, Mothership","Fighter_vs_Frigate",
{Fighter="Fighter_vs_Fighter"},
{Fighter_hw1="Fighter_vs_Fighter"},
{Swarmer="Fighter_vs_Fighter"},
...
addAbility(NewShipType,"CustomCommand",1,"Speed Burst",1,0,1200,120,12,3,1100,"data:Ship/Tai_Scout/Tai_Scout.lua","Start_Tai_Scout","Do_Tai_Scout","Finish_Tai_Scout","Tai_Scout",1.5,3,1)
LoadSharedModel(NewShipType,"Tai_Scout");
StartShipWeaponConfig(NewShipType,"Tai_Scout","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Tai_Scout","Weapon_Gun1","Weapon_Gun1");
...
setEngineTrail(NewShipType,0,3.6,"trail_ribbon.tga",0.01,0.5,0.025,1.5);
