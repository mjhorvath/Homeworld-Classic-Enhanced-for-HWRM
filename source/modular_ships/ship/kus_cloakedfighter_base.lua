...
NewShipType.displayedName="$10008"
NewShipType.sobDescription="$10009"
...
NewShipType.mainEngineMaxSpeed=430
NewShipType.rotationMaxSpeed=107
...
setSupplyValue(NewShipType, "CloakedFighters", 1.0)
...
addAbility(NewShipType,"CanAttack",1,0,1,0,0.35,1,"Fighter_hw1, Fighter, Corvette_hw1, Corvette, Frigate, Utility, Resource,,,,SmallCapitalShip, BigCapitalShip, Mothership","FlyBy_Interceptor_vs_Frigate",
...
addAbility(NewShipType,"CloakAbility",1,3,25,2222,0,0,222,222);
addAbility(NewShipType,"RetireAbility",1,0);
addCustomCode(NewShipType, "data:ship/Kus_CloakedFighter/Kus_CloakedFighter.lua", "", "", "Update_Kus_CloakedFighter", "Destroy_Kus_CloakedFighter", "Kus_CloakedFighter", 1)
LoadSharedModel(NewShipType,"Kus_CloakedFighter");
StartShipWeaponConfig(NewShipType,"Kus_CloakedFighter","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Kus_CloakedFighter","Weapon_Gun1","Weapon_Gun1");
