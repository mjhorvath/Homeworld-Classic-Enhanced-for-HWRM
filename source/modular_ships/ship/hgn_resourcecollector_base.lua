...
NewShipType.displayedName="$1532"
NewShipType.sobDescription="$1533"
...
NewShipType.layoutBoundY=35
NewShipType.layoutBoundZ=35
...
NewShipType.BuildFamily="Utility_Hgn"
...
NewShipType.goblinsStartFade=660
NewShipType.goblinsOff=660
...
addAbility(NewShipType,"CanAttack",1,5,2,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Frigate, Utility, SmallCapitalShip, BigCapitalShip, Mothership","kamikaze",
{Fighter="kamikaze"},
...
addAbility(NewShipType,"RepairCommand",0,500,14,0,"",{SuperCap="21"},{Flagship="21"});
addAbility(NewShipType,"RetireAbility",1,0);
addAbility(NewShipType,"CanBeSalvageCaptured",0,0.75,0,1,1,"SalCap"); 
LoadSharedModel(NewShipType,"Hgn_ResourceCollector");
...
setEngineTrail(NewShipType,0,3,"trail_ribbon.tga",0.001,0.1,0.025,2);
setEngineTrail(NewShipType,1,3,"trail_ribbon.tga",0.001,0.1,0.025,2);
