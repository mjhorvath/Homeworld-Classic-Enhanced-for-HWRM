...
if resBool == 1 then
	resourceModule = "Tai_CarrierResource"
end
...
addAbility(NewShipType,"ShipHold",1,60,100,"rallypoint","Fighter, Corvette, Utility",100,
{Fighter="36"},
{Corvette="340"},
{Utility="175"});
...
addCustomCode(NewShipType,"data:Ship/Tai_Carrier/Tai_Carrier.lua","Load_Tai_Carrier","Create_Tai_Carrier","Update_Tai_Carrier","","Tai_Carrier",2)
LoadSharedModel(NewShipType,"Tai_Carrier");
