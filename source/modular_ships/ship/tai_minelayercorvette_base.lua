...
NewShipType.displayedName="$10018"
NewShipType.sobDescription="$10019"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 1800)
...
NewShipType.rotationMaxSpeed=130
...
addAbility(NewShipType,"CanAttack",1,0,1,0,0.35,1,"BigCapitalShip, SmallCapitalShip, Frigate, Corvette_hw1, Corvette, Fighter_hw1, Fighter, Utility","FlyRound_MinelayerCorvette_vs_Frigate",
...
LoadSharedModel(NewShipType,"Tai_MinelayerCorvette");
StartShipWeaponConfig(NewShipType,"Tai_MineLayer","Weapon_Gun0","Weapon_Mine");
...
setEngineTrail(NewShipType,0,3.2,"trail_ribbon.tga",0.1,0.2,0.025,1.45);
