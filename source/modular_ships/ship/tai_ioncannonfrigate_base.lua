...
NewShipType.displayedName="$10026"
NewShipType.sobDescription="$10027"
...
setTargetBox(NewShipType, 0, -0.3,-0.6,-0.9, 0.3,0.13,0.55)
...
addAbility(NewShipType,"CanAttack",1,1,0,1,0.35,1.5,"Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Mothership, Utility,,,,, Corvette_hw1, Corvette, Fighter_hw1, Fighter, Swarmer","frontal_frigate",
{SubSystem="FrontalVsSubSystem"},
{Fighter="frontal_vs_fighter"},
{Fighter_hw1="frontal_vs_fighter"},
{Swarmer="frontal_vs_fighter"},
...
addCustomCode(NewShipType,"data:ship/Tai_IonCannonFrigate/Tai_IonCannonFrigate.lua","","","Update_Tai_IonCannonFrigate","","Tai_IonCannonFrigate",4)
LoadSharedModel(NewShipType,"Tai_IonCannonFrigate");
StartShipWeaponConfig(NewShipType,"Tai_IonCannon","Weapon_Gun0","Weapon_Gun0");
