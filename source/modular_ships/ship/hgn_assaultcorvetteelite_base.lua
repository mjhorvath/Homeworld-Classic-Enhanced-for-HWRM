...
NewShipType.displayedName="$1570"
...
addAbility(NewShipType,"CanAttack",1,1,1,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Frigate, Utility, Resource,,,,SmallCapitalShip, BigCapitalShip","flyround_AssaultCorvette_vs_Frigate",
...
NewShipType.explosiveScuttleDamageOnDeath=105
NewShipType.maxFalloffForce=25*10
NewShipType.explosiveDamageOnDeath=21
