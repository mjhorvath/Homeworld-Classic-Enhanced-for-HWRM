...
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 120000)
...
setTargetBox(NewShipType, 0, -0.4,-0.3,-0.6, 0.4,0.3,0.6)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=120
NewShipType.layoutBoundY=80
NewShipType.layoutBoundZ=270
NewShipType.layoutCenterX=0
NewShipType.layoutCenterY=-10
...
NewShipType.buildCost=3500
NewShipType.buildTime=130
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"Fighter_hw1, Fighter, Swarmer, Corvette_hw1, Corvette, Frigate, SmallCapitalShip, BigCapitalShip, Utility","JustShoot");
addAbility(NewShipType,"GuardCommand",1,3000,1000);
addAbility(NewShipType,"CanBuildShips",1,"Fighter_Kus, Corvette_Kus, Frigate_Kus, Resource_Kus, NonCombat_Kus","Fighter, Corvette, Frigate, Resource, NonCombat");
...
addCustomCode(NewShipType,"data:Ship/Kus_Carrier/Kus_Carrier.lua","Load_Kus_Carrier","Create_Kus_Carrier","Update_Kus_Carrier","","Kus_Carrier",2)
LoadSharedModel(NewShipType,"Kus_Carrier");
StartShipWeaponConfig(NewShipType,"HW1_MothershipGun2","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"HW1_MothershipGun2","Weapon_Gun1","Weapon_Gun1");
StartShipWeaponConfig(NewShipType,"HW1_MothershipGun2","Weapon_Gun2","Weapon_Gun2");
StartShipWeaponConfig(NewShipType,"HW1_MothershipGun2","Weapon_Gun3","Weapon_Gun3");
addShield(NewShipType,"EMP",10000,20);
StartShipHardPointConfig(NewShipType,"Engine","Hardpoint_Engine","System","Innate","Damageable","Kus_CarrierEngine","","","","","","","","");
...
SpawnSalvageOnDeath(NewShipType,"Slv_Chunk_Lrg05",1, 0.10,0,0,0, 25,10,-100,30,35,75,62,75,0,0,0,80,0,0,0,50);
