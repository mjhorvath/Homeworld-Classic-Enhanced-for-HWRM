...
addAbility(NewShipType,"CustomCommand",1,"Speed Burst",1,0,1200,120,12,3,1100,"data:Ship/Kus_Scout/Kus_Scout.lua","Start_Kus_Scout","Do_Kus_Scout","Finish_Kus_Scout","Kus_Scout",1.5,3,1)
LoadSharedModel(NewShipType,"Kus_Scout");
StartShipWeaponConfig(NewShipType,"Kus_Scout","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Kus_Scout","Weapon_Gun1","Weapon_Gun1");
...
setEngineTrail(NewShipType,0,3.86,"trail_ribbon.tga",0.001,0.5,0.025,2);
