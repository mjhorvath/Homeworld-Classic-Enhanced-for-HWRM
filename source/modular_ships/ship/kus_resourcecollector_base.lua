...
setTargetBox(NewShipType, 0, -0.25,-0.9,-0.8, 0.25,0.13,0.5)
...
NewShipType.BuildFamily="Resource_Kus"
...
if hypBool == 1 and (getShipNum(NewShipType, "resCanHyper", 1) > 0) then
...
addCustomCode(NewShipType,"data:ship/Kus_ResourceCollector/Kus_ResourceCollector.lua","","","Update_Kus_ResourceCollector","","Kus_ResourceCollector",4)
LoadSharedModel(NewShipType,"Kus_ResourceCollector");
...
setEngineTrail(NewShipType,0,4.4,"trail_ribbon.tga",0.001,0.1,0.025,1);
setEngineTrail(NewShipType,1,4.4,"trail_ribbon.tga",0.001,0.1,0.025,1);
