...
NewShipType.displayedName="$10004"
NewShipType.sobDescription="$10005"
...
NewShipType.thrusterMaxSpeed=420
NewShipType.mainEngineMaxSpeed=420
...
setSupplyValue(NewShipType, "Bomber", 1.0)
...
NewShipType.antiFrigateValue=1.8
...
addAbility(NewShipType,"CanAttack",1,0,1,0,0.35,1,"Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Corvette_hw1, Corvette, Fighter_hw1, Fighter, Swarmer, Utility","Bomber_vs_Frigate",
{Fighter="Bomber_vs_Fighter"},
{Fighter_hw1="Bomber_vs_Fighter"},
{Swarmer="Bomber_vs_Fighter"},
...
LoadSharedModel(NewShipType,"Kus_AttackBomber");
...
setEngineTrail(NewShipType,0,3.6,"trail_ribbon.tga",0.01,0.5,0.025,1.25);
