...
NewShipType.regentime=1074
NewShipType.minRegenTime=1074
...
setTargetBox(NewShipType, 0, -0.2,-0.45,-0.6, 0.2,0.45,0.15)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=75
NewShipType.layoutBoundY=75
NewShipType.layoutBoundZ=225
...
{Corvette="movetotargetandshoot_VgrDestroyer_vs_Corvettes"},
{Corvette_hw1="movetotargetandshoot_VgrDestroyer_vs_Corvettes"},
...
addAbility(NewShipType,"CanBeSalvageCaptured",0,0.75,0,0,1,"SalCap"); 
addAbility(NewShipType,"CanBeRepaired","RepCap");
addAbility(NewShipType,"RetireAbility",1,0);
addCustomCode(NewShipType,"data:ship/Vgr_Destroyer/Vgr_Destroyer.lua","","","Update_Vgr_Destroyer","","Vgr_Destroyer",4)
LoadSharedModel(NewShipType,"Vgr_Destroyer");
StartShipHardPointConfig(NewShipType,"Weapon_FlechetteBottom","Hardpoint_FlechetteBottom","Weapon","Innate","Ship","Vgr_FlechetteCannonDestroyer","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_FlechetteTop","Hardpoint_FlechetteTop","Weapon","Innate","Ship","Vgr_FlechetteCannonDestroyer","","","","","","","","");
...
addShield(NewShipType,"EMP",850,20);
