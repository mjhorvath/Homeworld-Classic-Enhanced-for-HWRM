...
setTargetBox(NewShipType, 0, -0.3,-0.53,-0.86, 0.3,0.47,0.55)
...
addCustomCode(NewShipType,"data:ship/Kus_IonCannonFrigate/Kus_IonCannonFrigate.lua","","","Update_Kus_IonCannonFrigate","","Kus_IonCannonFrigate",4)
LoadSharedModel(NewShipType,"Kus_IonCannonFrigate");
StartShipWeaponConfig(NewShipType,"Kus_IonCannon","Weapon_Gun0","Weapon_Gun0");
