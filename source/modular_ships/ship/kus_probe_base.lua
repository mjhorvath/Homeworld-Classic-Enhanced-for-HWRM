...
NewShipType.displayedName="$10054"
NewShipType.sobDescription="$10055"
...
setTargetBox(NewShipType, 0, -0.1,-0.1,0.5, 0.1,1.0,1.0)
...
setSupplyValue(NewShipType, "Probe_hw1", 1.0)
...
NewShipType.visualRange = getShipNum(NewShipType, "visualRange", 4000)
holdRange = getShipNum(NewShipType, "miscSensorRange", 10500)
...
LoadSharedModel(NewShipType,"Kus_Probe");
