...
NewShipType.upLOD=227900
NewShipType.downLOD=227915
...
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",1,10,100,400,0,3);
end
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"BigCapitalShip, SmallCapitalShip, Mothership, Frigate, Corvette, Fighter","Frontal",{Fighter="MoveToTargetAndShoot"},{Corvette="MoveToTargetAndShoot"});
if hypBool == 1 then
...
NewShipType.specialCooldownName="Weapon_BigGun";
