...
setTargetBox(NewShipType, 0, -0.25,-0.58,-0.95, 0.25,0.5,0.4)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=30
NewShipType.layoutBoundY=65
NewShipType.layoutBoundZ=130
...
addCustomCode(NewShipType,"data:ship/Kus_ResourceController/Kus_ResourceController.lua","","","Update_Kus_ResourceController","","Kus_ResourceController",4)
LoadSharedModel(NewShipType,"Kus_ResourceController");
