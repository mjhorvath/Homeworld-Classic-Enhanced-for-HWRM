...
NewShipType.displayedName="$1502"
NewShipType.sobDescription="$1503"
...
NewShipType.testManeuver1="NinetyDegRightTurn"
...
addAbility(NewShipType,"CanAttack",1,2,1,0,0.35,2.5,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Frigate, Utility, Resource,,,, SmallCapitalShip, BigCapitalShip, Mothership","Fighter_vs_Frigate",
...
LoadSharedModel(NewShipType,"Hgn_Interceptor");
