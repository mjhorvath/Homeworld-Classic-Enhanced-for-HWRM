...
LoadSharedModel(NewShipType,"Tai_SalvageCorvette");
...
setEngineTrail(NewShipType,0,2.6,"trail_ribbon.tga",0.01,0.1,0.015,2.5);
setEngineTrail(NewShipType,1,2.6,"trail_ribbon.tga",0.01,0.1,0.015,2.5);
setEngineTrail(NewShipType,2,2.6,"trail_ribbon.tga",0.01,0.1,0.015,2.5);
setEngineTrail(NewShipType,3,2.6,"trail_ribbon.tga",0.01,0.1,0.015,2.5);
setEngineBurn(NewShipType,16,0.5,1,23,0,0.7,0.15,42);
