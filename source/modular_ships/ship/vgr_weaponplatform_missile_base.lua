...
setTacticsMults(NewShipType, "ROTATION", 0.97, 1.05, 1.0)
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Mothership, Utility, Corvette, Corvette_hw1, Fighter, Fighter_hw1","justshootVgrPlatform");
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
LoadSharedModel(NewShipType,"Vgr_WeaponPlatform_Missile");
