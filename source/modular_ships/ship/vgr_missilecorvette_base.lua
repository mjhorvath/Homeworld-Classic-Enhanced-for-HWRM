...
NewShipType.displayedName="$1612"
NewShipType.sobDescription="$1613"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 480)
...
setTacticsMults(NewShipType, "FIRERATE", 0.95, 3.25, 1.0)
setSpeedvsAccuracyApplied(NewShipType, 50.0, 5.0, 180, 1.0, 250, 1.0, 312, 0.90, 319, 0.80)
...
NewShipType.batchFormation="SG_2x2Wall"
NewShipType.defaultROE="Defensive"
NewShipType.defaultStance="Aggressive"
NewShipType.holdSlots=2.5
NewShipType.mass=15
NewShipType.collisionMultiplier=0.6
NewShipType.thrusterMaxSpeed=231*0.9
NewShipType.mainEngineMaxSpeed=231
NewShipType.rotationMaxSpeed=131*0.95
NewShipType.thrusterAccelTime=2*1.075
NewShipType.thrusterBrakeTime=1*1.075
NewShipType.mainEngineAccelTime=2*1.075
NewShipType.mainEngineBrakeTime=1*1.075
NewShipType.rotationAccelTime=0.6*1.075
NewShipType.rotationBrakeTime=0.3*1.075
NewShipType.thrusterUsage=1
NewShipType.accelerationAngle=170
NewShipType.mirrorAngle=30
NewShipType.secondaryTurnAngle=0
NewShipType.maxBankingAmount=65
...
NewShipType.BuildFamily="Corvette_Vgr"
...
setSupplyValue(NewShipType, "Corvette", 3.0)
setSupplyValue(NewShipType, "LayoutCorvette", 3.0)
NewShipType.CombatFamily="Corvette_Missile"
NewShipType.fighterValue=0
NewShipType.corvetteValue=2.5
NewShipType.frigateValue=0
NewShipType.neutralValue=0
NewShipType.antiFighterValue=0
NewShipType.antiCorvetteValue=2.5
NewShipType.antiFrigateValue=0
NewShipType.totalValue=2.5
...
addAbility(NewShipType,"CanAttack",1,2,1,0,0.35,0.95,"Corvette, Corvette_hw1, Fighter, Fighter_hw1,,,,,,, Frigate, SmallCapitalShip, BigCapitalShip, Utility","FlyRound_MissileCorvette_vs_Frigate",
{Fighter="FlyRound_Corvette_vs_Fighter"},
{Fighter_hw1="FlyRound_Corvette_vs_Fighter"},
{Mothership="flyround_MissileCorvette_vs_Mothership"},
{SmallCapitalShip="FlyRound_MissileCorvette_vs_CapShip"},
{BigCapitalShip="FlyRound_MissileCorvette_vs_CapShip"},
{SubSystem="FrontalVsSubSystem_Corvette"},
{Corvette="FlyRound_MissileCorvette_vs_Corvette"},
{Corvette_hw1="FlyRound_MissileCorvette_vs_Corvette"},
{Frigate="FlyRound_MissileCorvette_vs_Frigate"});
addAbility(NewShipType,"GuardCommand",1,3000,500);
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
addAbility(NewShipType,"RetireAbility",1,0);
addCustomCode(NewShipType, "data:ship/Vgr_MissileCorvette/Vgr_MissileCorvette.lua", "", "", "Update_Vgr_Missile_Corvette", "", "Vgr_MissileCorvette", 1)
LoadSharedModel(NewShipType,"Vgr_MissileCorvette");
StartShipWeaponConfig(NewShipType,"Vgr_ConcussionMissileLauncher","Weapon_MissileVette","Fire_Missile");
StartShipWeaponConfig(NewShipType,"Vgr_ConcussionMissileLauncher_Medium","Weapon_MissileVetteAlt","Fire_MissileAlt");
addShield(NewShipType,"EMP",110,20);
...
setEngineTrail(NewShipType,0,6,"trail_ribbon.tga",0.005,0.1,0.025,2);
setEngineBurn(NewShipType,12,0.5,1,12,0,0.7,0.1,35);
loadShipPatchList(NewShipType,"data:sound/sfx/ship/Vaygr/Corvette/",0,"Engines/VCorvetteEng","",1,"Ambience/VCorvetteAmb","");
NewShipType.minFalloffDamageDist=40
NewShipType.maxFalloffDamageDist=40*3
NewShipType.maxFalloffScuttleDamageDist=40*4
NewShipType.explosiveScuttleDamageOnDeath=50
NewShipType.maxFalloffForce=25*10
NewShipType.explosiveDamageOnDeath=10
