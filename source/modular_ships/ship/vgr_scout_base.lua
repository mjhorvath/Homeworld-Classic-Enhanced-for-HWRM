...
NewShipType.displayedName="$1600"
NewShipType.sobDescription="$1601"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 90)
...
NewShipType.batchFormation="Batch_Dart"
...
NewShipType.thrusterAccelTime=1.5*1.15
NewShipType.thrusterBrakeTime=0.75*1.1
NewShipType.mainEngineAccelTime=1.5*1.15
NewShipType.mainEngineBrakeTime=0.75*1.1
...
NewShipType.specialTurnLeftManeuver="NinetyDegLeftTurn"
NewShipType.specialTurnRightManeuver="NinetyDegRightTurn"
...
setSupplyValue(NewShipType, "Fighter", 3.0)
setSupplyValue(NewShipType, "Scout", 3.0)
setSupplyValue(NewShipType, "LayoutFighter", 3.0)
NewShipType.CombatFamily="Fighter_EMPScout"
NewShipType.fighterValue=0.33
...
addAbility(NewShipType,"CanAttack",1,1,1,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1,,,,, Frigate, SmallCapitalShip, BigCapitalShip, Mothership","FlyBy_Interceptor_vs_Frigate",
...
addCustomCode(NewShipType, "data:ship/Vgr_Scout/Vgr_Scout.lua", "", "", "Update_Vgr_Scout", "", "Vgr_Scout", 1)
LoadSharedModel(NewShipType,"Vgr_Scout");
StartShipWeaponConfig(NewShipType,"Vgr_Peashooter","Weapon_Autogun","Weapon_Autogun");
StartShipWeaponConfig(NewShipType,"Vgr_SmallEMP","Weapon_Autogun","Weapon_EMP");
...
setEngineTrail(NewShipType,0,6,"trail_ribbon.tga",0.001,0.5,0.025,7);
setEngineBurn(NewShipType,18,0.5,1,12,0,0.7,0.1,25);
loadShipPatchList(NewShipType,"data:sound/sfx/ship/Vaygr/Fighter/",0,"VScoutEng","");
addShield(NewShipType,"EMP",200,20);
