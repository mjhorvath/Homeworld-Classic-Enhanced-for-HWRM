...
NewShipType.displayedName="$10012"
NewShipType.sobDescription="$10013"
...
NewShipType.mass=15
NewShipType.collisionMultiplier=0.5
NewShipType.thrusterMaxSpeed=305
NewShipType.mainEngineMaxSpeed=305
NewShipType.rotationMaxSpeed=100
NewShipType.thrusterAccelTime=4.6
NewShipType.thrusterBrakeTime=2.2
NewShipType.mainEngineAccelTime=4.6
NewShipType.mainEngineBrakeTime=2.2
...
NewShipType.tumbleDynamicX=75
NewShipType.tumbleDynamicY=135
NewShipType.tumbleDynamicZ=35
NewShipType.tumbleSpecialDynamicX=20
NewShipType.tumbleSpecialDynamicY=100
NewShipType.tumbleSpecialDynamicZ=50
...
NewShipType.antiFighterValue=3.33
NewShipType.antiCorvetteValue=2
NewShipType.antiFrigateValue=0
NewShipType.totalValue=3.33
NewShipType.buildCost=215
NewShipType.buildTime=17
...
addAbility(NewShipType,"CanAttack",1,0,1,0,0.35,1,"Fighter_hw1, Fighter, Swarmer,,,,,,, Corvette_hw1, Corvette, Frigate, Capturer, Utility, SmallCapitalShip, BigCapitalShip, Mothership","frontal_LightCorvette",
{Fighter="frontal_LightCorvette"},
{Fighter_hw1="frontal_LightCorvette"},
{Swarmer="frontal_LightCorvette"},
{Frigate="frontal_LightCorvette"},
{Corvette="frontal_LightCorvette"},
{Corvette_hw1="frontal_LightCorvette"},
{SmallCapitalShip="frontal_LightCorvette"},
{BigCapitalShip="frontal_LightCorvette"},
{Mothership="frontal_LightCorvette"},
...
LoadSharedModel(NewShipType,"Tai_LightCorvette");
StartShipWeaponConfig(NewShipType,"Tai_LtCorvette","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Tai_LtCorvette","Weapon_Gun1","Weapon_Gun1");
...
setEngineTrail(NewShipType,0,4.72,"trail_ribbon.tga",0.01,0.2,0.025,3.45);
