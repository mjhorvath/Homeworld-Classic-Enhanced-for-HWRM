...
NewShipType.displayedName="$10046"
NewShipType.sobDescription="$10047"
...
NewShipType.rotationMaxSpeed=56
NewShipType.thrusterAccelTime=7
NewShipType.thrusterBrakeTime=2
NewShipType.mainEngineAccelTime=7
NewShipType.mainEngineBrakeTime=2
NewShipType.rotationAccelTime=0.44
NewShipType.rotationBrakeTime=0.24
NewShipType.thrusterUsage=1
NewShipType.accelerationAngle=39
NewShipType.mirrorAngle=0
NewShipType.secondaryTurnAngle=0
NewShipType.maxBankingAmount=31
NewShipType.descendPitch=72
...
NewShipType.goblinsStartFade=750
NewShipType.goblinsOff=750
...
addAbility(NewShipType,"CanAttack",1,5,2,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Frigate, Utility, SmallCapitalShip, BigCapitalShip, Mothership","kamikaze",
{Fighter="kamikaze"},
{Fighter_hw1="kamikaze"},
{SubSystem="kamikaze"},
{SmallCapitalShip="kamikaze"},
{BigCapitalShip="kamikaze"},
{Mothership="kamikaze"},
...
addCustomCode(NewShipType,"data:ship/Tai_ResourceCollector/Tai_ResourceCollector.lua","","","Update_Tai_ResourceCollector","","Tai_ResourceCollector",4)
LoadSharedModel(NewShipType,"Tai_ResourceCollector");
addShield(NewShipType,"EMP",225,20);
...
setEngineTrail(NewShipType,0,1.4,"trail_ribbon.tga",0.1,0.1,0.025,1);
setEngineTrail(NewShipType,1,1.4,"trail_ribbon.tga",0.1,0.1,0.025,1);
setEngineTrail(NewShipType,2,1.4,"trail_ribbon.tga",0.1,0.1,0.025,1);
setEngineTrail(NewShipType,3,1.4,"trail_ribbon.tga",0.1,0.1,0.025,1);
setEngineBurn(NewShipType,7,0.5,0.6,16,1.05,0.1,0.25,28);
...
--loadLatchPointList(NewShipType,"RepCap","SalvagePoint1","SalvagePoint2","CapturePoint1");								 
SpawnDustCloudOnDeath(NewShipType, "DustCloud_0", 1, 0,70,0,0, 0,0,0,40, 0,0,0,120, 0,0,0,10, 1.0,0.349,0.199,0.2, 100,50)
