...
LoadSharedModel(NewShipType,"Kus_HeavyCorvette");
StartShipHardPointConfig(NewShipType,"Weapon_Gun0","Hardpoint_Gun0","Weapon","Innate","Ship","Kus_HvCorvette1","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_Gun1","Hardpoint_Gun1","Weapon","Innate","Ship","Kus_HvCorvette2","","","","","","","","");
...
setEngineTrail(NewShipType,0,5.5,"trail_ribbon.tga",0.01,0.2,0.025,4.25);
