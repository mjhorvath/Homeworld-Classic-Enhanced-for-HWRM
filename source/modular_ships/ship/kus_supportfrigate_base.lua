...
NewShipType.displayedName="$10028"
NewShipType.sobDescription="$10029"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 21000)
...
NewShipType.paradeData="kus_repairer_parade"
...
NewShipType.thrusterMaxSpeed=287
NewShipType.mainEngineMaxSpeed=287
NewShipType.rotationMaxSpeed=47
NewShipType.thrusterAccelTime=2
NewShipType.thrusterBrakeTime=0.9
...
setTargetBox(NewShipType, 0, -0.3,0.43,-0.86, 0.3,-0.3,0.4)
...
addAbility(NewShipType,"ShipHold",1,0,0,"rallypoint","",70,
{Fighter="36"},
{Corvette="340"});
...
addAbility(NewShipType,"CanAttack",1,1,0,1,0.35,1.5,"Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Mothership, Utility, Corvette_hw1, Corvette, Fighter_hw1, Fighter, Swarmer","Frontal_SupportFrigate",
...
addAbility(NewShipType,"RepairCommand",1,440,1,1,"Frontal_SupportFrigate",
{Flagship=2.0},
{SuperCap=2.0}, 
{BattleCruiser=2.0}, 
{Carrier=1.5}, 
...
{Corvette=1.5},
{EndRepairRates=0},
{Corvette="Frontal_RepairFrigate_Frigate"},
{Corvette_hw1="Frontal_RepairFrigate_Frigate"},
{Frigate="Frontal_RepairFrigate_Frigate"},
{SmallCapitalShip="frontal_RepairFrigate_SmallCap"},
{BigCapitalShip="Frontal_RepairFrigate_BigCap"},
{Mothership="frontal_RepairFrigate_Mothership"});
addAbility(NewShipType,"RetireAbility",1,0);
addCustomCode(NewShipType,"data:Ship/Kus_SupportFrigate/Kus_SupportFrigate.lua","","Create_Kus_SupportFrigate","Update_Kus_SupportFrigate","Destroy_Kus_SupportFrigate","Kus_SupportFrigate",1)
LoadSharedModel(NewShipType,"Kus_SupportFrigate");
StartShipHardPointConfig(NewShipType,"Weapon_Gun0","Hardpoint_Gun0","Weapon","Innate","Ship","Kus_SupportGun","","","","","","","","");
StartShipWeaponConfig(NewShipType,"Kus_SupportGunHeal","Weapon_Rep0","Weapon_Rep0");
