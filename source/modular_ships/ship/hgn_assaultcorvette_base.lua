...
NewShipType.rotationMaxSpeed=172*0.95
...
NewShipType.rotationAccelTime=0.62*1.075
...
NewShipType.CombatFamily="Corvette_Gunship"
...
addAbility(NewShipType,"CanAttack",1,1,1,0,0.35,1.5,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Frigate, Utility, Resource,,,,SmallCapitalShip, BigCapitalShip","flyround_AssaultCorvette_vs_Frigate",
{Fighter="flyround_Corvette_vs_Fighter"},
{Fighter_hw1="flyround_Corvette_vs_Fighter"},
{Mothership="flyround_AssaultCorvette_vs_Mothership"},
{SmallCapitalShip="flyround_AssaultCorvette_vs_CapShip"},
{BigCapitalShip="flyround_AssaultCorvette_vs_CapShip"},
{SubSystem="FrontalVsSubSystem_Corvette"},
{Corvette="flyround_AssaultCorvette_vs_Frigate"},
{Corvette_hw1="flyround_AssaultCorvette_vs_Frigate"});
addAbility(NewShipType,"GuardCommand",1,3000,500);
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
addAbility(NewShipType,"RetireAbility",1,0);
addCustomCode(NewShipType, "data:ship/Hgn_AssaultCorvette/Hgn_AssaultCorvette.lua", "", "", "Update_Hgn_Assault_Corvette", "", "Hgn_AssaultCorvette", 1)
