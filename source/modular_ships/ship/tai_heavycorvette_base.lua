...
NewShipType.displayedName="$10014"
NewShipType.sobDescription="$10015"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 1700)
...
setTacticsMults(NewShipType, "ROTATION", 1.15, 1.10, 1.0)
...
setTacticsMults(NewShipType, "BULLETSPEED", 1.10, 1.0, 1.0)
...
NewShipType.thrusterAccelTime=4*1.075
NewShipType.thrusterBrakeTime=1*1.075
NewShipType.mainEngineAccelTime=4*1.275
NewShipType.mainEngineBrakeTime=1*1.275
NewShipType.rotationAccelTime=0.6*2.75
NewShipType.rotationBrakeTime=0.3*2.75
NewShipType.thrusterUsage=1
NewShipType.accelerationAngle=170
NewShipType.mirrorAngle=30
NewShipType.secondaryTurnAngle=0
NewShipType.maxBankingAmount=35
...
NewShipType.BuildFamily="Corvette_Tai"
...
NewShipType.corvetteValue=4.33
NewShipType.frigateValue=0
NewShipType.neutralValue=0
NewShipType.antiFighterValue=1
NewShipType.antiCorvetteValue=3
NewShipType.antiFrigateValue=5
NewShipType.totalValue=4.33
NewShipType.buildCost=230
NewShipType.buildTime=19
...
addAbility(NewShipType,"CanAttack",1,0,1,1,0.35,1,"Corvette_hw1, Corvette, Frigate, SmallCapitalShip, BigCapitalShip, Resource, Utility,,,,,,, Fighter_hw1, Fighter, Swarmer, Mothership","frontal_HeavyCorvette",
{Fighter="frontal_HeavyCorvette_vs_Fighters"},
{Fighter_hw1="frontal_HeavyCorvette_vs_Fighters"},
{Swarmer="frontal_HeavyCorvette_vs_Fighters"},
{Frigate="frontal_HeavyCorvette"},
{Corvette="frontal_HeavyCorvette"},
{Corvette_hw1="frontal_HeavyCorvette"},
{SmallCapitalShip="frontal_HeavyCorvette"},
{BigCapitalShip="frontal_HeavyCorvette"},
{Mothership="frontal_HeavyCorvette"},
{SubSystem="FrontalVsSubSystem"},
{ResourceLarge="frontal_HeavyCorvette"});
addAbility(NewShipType,"GuardCommand",1,3000,500);
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
addAbility(NewShipType,"RetireAbility",1,0);
addAbility(NewShipType, "SpecialAttack", 1, "BurstAttack")
LoadSharedModel(NewShipType,"Tai_HeavyCorvette");
--StartShipWeaponConfig(NewShipType,"Tai_HvCorvette1","Weapon_Gun0","Weapon_Gun0");
--StartShipWeaponConfig(NewShipType,"Tai_HvCorvette1","Weapon_Gun1","Weapon_Gun1");
--StartShipWeaponConfig(NewShipType,"Tai_HvCorvette2","Weapon_Gun2","Weapon_Gun2");
--StartShipWeaponConfig(NewShipType,"Tai_HvCorvette2","Weapon_Gun3","Weapon_Gun3");
--StartShipWeaponConfig(NewShipType,"Tai_HvCorvette_Special1","Weapon_Gun0","Weapon_Gun_special0");
--StartShipWeaponConfig(NewShipType,"Tai_HvCorvette_Special2","Weapon_Gun1","Weapon_Gun_special1");
StartShipHardPointConfig(NewShipType,"Weapon_Gun0","Hardpoint_Gun0","Weapon","Innate","Ship","Tai_CorvetteGun","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_Gun1","Hardpoint_Gun1","Weapon","Innate","Ship","Tai_CorvetteGun","","","","","","","","");
...
setEngineTrail(NewShipType,0,5.25,"trail_ribbon.tga",0.01,0.2,0.025,2.45);
setEngineBurn(NewShipType,13,0.5,1,15,0,0.7,0.15,30);
...
NewShipType.minFalloffDamageDist=35
NewShipType.maxFalloffDamageDist=35*3
NewShipType.maxFalloffScuttleDamageDist=35*4
NewShipType.explosiveScuttleDamageOnDeath=128
NewShipType.maxFalloffForce=25*10
NewShipType.explosiveDamageOnDeath=26
