...
NewShipType.displayedName="$10072"
NewShipType.sobDescription="$10073"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth",26000)
...
NewShipType.mainEngineMaxSpeed=135
...
setTargetBox(NewShipType, 0, -0.3,-0.3,-0.7, 0.3,0.3,0.7)
...
NewShipType.BuildFamily="Frigate_Tur"
...
LoadSharedModel(NewShipType,"Tur_IonArrayFrigate");
StartShipWeaponConfig(NewShipType,"Tur_IonCannon","Weapon_Gun0","Weapon_Gun0");
...
loadLatchPointList(NewShipType,"SalCap","CapturePoint0","CapturePoint1");
loadShipPatchList(NewShipType,"data:sound/sfx/ship/",0,"Hiigaran/Frigate/Engines/HFrigateEng","",1,"misc/chatter/turanicraider","");
