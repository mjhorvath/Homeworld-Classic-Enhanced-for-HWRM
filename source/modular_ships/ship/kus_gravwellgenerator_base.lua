...
NewShipType.displayedName="$10050"
NewShipType.sobDescription="$10051"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 11000)
...
NewShipType.thrusterMaxSpeed=114
NewShipType.mainEngineMaxSpeed=114
...
setTargetBox(NewShipType, 0, -0.70,-0.63,-0.52, 0.70,0.63,0.65)
NewShipType.dustCloudDamageTime=160
NewShipType.nebulaDamageTime=200
NewShipType.MinimalFamilyToFindPathAround="MotherShip"
NewShipType.BuildFamily="NonCombat_Kus"
NewShipType.AttackFamily="NonCombat"
NewShipType.DockFamily = getShipStr(NewShipType, "DockFamily", "SuperCap")
...
setSupplyValue(NewShipType, "GravWellGenerator", 1.0)
...
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",1,3.5,250,2000,1,5);
end
addAbility(NewShipType,"GuardCommand",1,3000,300);
if hypBool == 1 then
...
addAbility(NewShipType,"CustomCommand",1,"$3191",1,0,166,1,0.65,0.0,300,"data:Ship/Kus_GravWellGenerator/Kus_GravWellGenerator.lua","Start_Kus_GravWellGenerator","Do_Kus_GravWellGenerator","Finish_Kus_GravWellGenerator","Kus_GravWellGenerator",1.0,1,1,1,1)
addCustomCode(NewShipType,"data:Ship/Kus_GravWellGenerator/Kus_GravWellGenerator.lua","","Create_Kus_GravWellGenerator","Update_Kus_GravWellGenerator","Destroy_Kus_GravWellGenerator","Kus_GravWellGenerator",1.0)
LoadSharedModel(NewShipType,"Kus_GravWellGenerator");
addShield(NewShipType,"EMP",220,20);
AddShipAbility(NewShipType, "Hyperspace", 0, "EnemyShipsWithinRadius", 10500)
AddShipMultiplier(NewShipType,"WeaponAccuracy","EnemyShipsWithinRadius","Linear",0.93,0.93,3000);
AddShipMultiplier(NewShipType,"HyperSpaceAbortDamage","ThisShipOnly","Linear",1.0,1.0,10500);
...
NewShipType.explosiveScuttleDamageOnDeath=675
NewShipType.maxFalloffForce=500*10
NewShipType.explosiveDamageOnDeath=135
