...
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 25900)
...
NewShipType.mainEngineMaxSpeed = getShipNum(NewShipType, "mainEngineMaxSpeed", 600)
NewShipType.thrusterMaxSpeed = getShipNum(NewShipType, "thrusterMaxSpeed", 600)
...
NewShipType.nebulaDamageTime=120
...
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",1,1,250,500,0,3);
	addAbility(NewShipType,"FormHyperspaceGateCommand",1,1000,500,500,0);
end
...
AddShipMultiplier(NewShipType,"SensorDistortion","ThisShipOnly","Linear",0.6,0.6,0);
