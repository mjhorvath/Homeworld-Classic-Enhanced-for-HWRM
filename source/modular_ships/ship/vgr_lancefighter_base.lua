...
NewShipType.displayedName="$1606"
NewShipType.sobDescription="$1607"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 110)
...
setSpeedvsAccuracyApplied(NewShipType, 100.0, 5.0, 120, 1.0, 250, 1.0, 388, 0.88, 535, 0.70)
...
NewShipType.thrusterMaxSpeed=300 * 0.77
...
NewShipType.layoutBoundX=17
NewShipType.layoutBoundY=17
NewShipType.layoutBoundZ=17
...
setSupplyValue(NewShipType, "LanceFighter", 5.0)
...
NewShipType.antiCorvetteValue=1.6
...
addAbility(NewShipType,"CanAttack",1,2,1,0,0.35,1,"Corvette, Corvette_hw1, Resource, Utility,,,,,Capturer, Frigate, Fighter, Fighter_hw1, SmallCapitalShip, BigCapitalShip","Fighter_vs_Frigate",
{Fighter="Fighter_vs_Fighter"},
{Fighter_hw1="Fighter_vs_Fighter"},
{Corvette="LanceFighter_vs_Corvette"},
{Corvette_hw1="LanceFighter_vs_Corvette"},
{Frigate="LanceFighter_vs_Frigate"},
...
addCustomCode(NewShipType, "data:ship/Vgr_LanceFighter/Vgr_LanceFighter.lua", "", "", "Update_Vgr_Lance_Fighter", "", "Vgr_LanceFighter", 1)
LoadSharedModel(NewShipType,"Vgr_LanceFighter");
...
setEngineTrail(NewShipType,0,5,"trail_ribbon.tga",0.001,0.5,0.025,7);
