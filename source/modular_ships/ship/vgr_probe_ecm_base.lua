...
setSupplyValue(NewShipType, "ECMProbe", 1.0)
...
NewShipType.prmSensorRange=14000
...
LoadSharedModel(NewShipType,"Vgr_Probe");
addShield(NewShipType,"EMP",50,20);
AddShipMultiplier(NewShipType,"SensorDistortion","OwnShipsWithinRadius","Linear",0.6,0.6,8000);
...
setEngineTrail(NewShipType,0,20,"trail_ribbon.tga",0.005,0.5,0.025,1.5);
