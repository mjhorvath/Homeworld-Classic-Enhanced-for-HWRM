...
NewShipType.displayedName="$1538"
...
setTargetBox(NewShipType, 0, -0.32,-0.32,-0.85, 0.65,0.12,0.8);
...
addAbility(NewShipType,"ShipHold",1,0,50,"rallypoint","Fighter, Corvette",25,{Fighter="3"},{Corvette="32"});
addAbility(NewShipType,"ParadeCommand",1);
addAbility(NewShipType,"WaypointMove");
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",0,2,500,1000,0,3);
end
addAbility(NewShipType,"CanAttack",1,1,0,1,0.35,1.5,"Capturer,Frigate,SmallCapitalShip,BigCapitalShip,Mothership,Utility,,,,,Corvette, Corvette_hw1,Fighter, Fighter_hw1","Frontal",
...
LoadSharedModel(NewShipType,"Hgn_Battlecruiser");
...
StartShipHardPointConfig(NewShipType,"Weapon_TurretTop4","Hardpoint_TurretTop4","Weapon","Innate","Ship","Hgn_BattleCruiserKineticBurstCannonRightSide","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_TurretTop3","Hardpoint_TurretTop3","Weapon","Innate","Ship","Hgn_BattleCruiserKineticBurstCannonLeftSide","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_TurretTop2","Hardpoint_TurretTop2","Weapon","Innate","Ship","Hgn_BattleCruiserKineticBurstCannon","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_TurretTop","Hardpoint_TurretTop","Weapon","Innate","Ship","Hgn_BattleCruiserKineticBurstCannon","","","","","","","","");
