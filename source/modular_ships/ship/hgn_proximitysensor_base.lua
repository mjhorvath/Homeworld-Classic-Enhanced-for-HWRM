...
NewShipType.displayedName="$1548"
NewShipType.sobDescription="$1549"
...
setSupplyValue(NewShipType, "ProximitySensor", 1.0)
...
LoadSharedModel(NewShipType,"Hgn_ProximitySensor");
...
setEngineTrail(NewShipType,0,3.4,"trail_ribbon.tga",0.001,0.1,0.025,2);
