...
NewShipType.displayedName="$1622"
NewShipType.sobDescription="$1623"
...
addAbility(NewShipType,"CanAttack",1,1,0,1,0.35,1.5,"Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Utility,,,,, Corvette, Corvette_hw1, Fighter, Fighter_hw1","frontal_frigate",
...
addCustomCode(NewShipType,"data:ship/Vgr_HeavyMissileFrigate/Vgr_HeavyMissileFrigate.lua","","","Update_Vgr_HeavyMissileFrigate","","Vgr_HeavyMissileFrigate",4)
LoadSharedModel(NewShipType,"Vgr_HeavyMissileFrigate");
StartShipWeaponConfig(NewShipType,"Vgr_HeavyFusionMissileLauncher","Weapon_Missile","Fire_Missile");
StartShipWeaponConfig(NewShipType,"Vgr_ConcussionMissileLauncherFrigate","Weapon_HullDefense","Fire_Missile1");
StartShipWeaponConfig(NewShipType,"Vgr_ConcussionMissileLauncherFrigateHeavy","Weapon_HullDefense","Fire_Missile1");
