...
setTargetBox(NewShipType, 0, -0.3,-0.6,-0.9, 0.3,0.8,0.66)
...
addCustomCode(NewShipType,"data:Ship/Tai_SupportFrigate/Tai_SupportFrigate.lua","","Create_Tai_SupportFrigate","Update_Tai_SupportFrigate","Destroy_Tai_SupportFrigate","Tai_SupportFrigate",1)
LoadSharedModel(NewShipType,"Tai_SupportFrigate");
StartShipHardPointConfig(NewShipType,"Weapon_Gun1","Hardpoint_Gun1","Weapon","Innate","Ship","Tai_FrigateCannon","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_Gun2","Hardpoint_Gun2","Weapon","Innate","Ship","Tai_FrigateCannon2","","","","","","","","");
StartShipWeaponConfig(NewShipType,"Tai_SupportGun1Heal","Weapon_Rep0","Weapon_Rep0");
