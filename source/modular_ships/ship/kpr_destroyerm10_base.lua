...
NewShipType.maxhealth=420000
NewShipType.regentime=600
NewShipType.minRegenTime=450
NewShipType.sideArmourDamage=1.5
NewShipType.rearArmourDamage=2.8
...
NewShipType.alternativeHyperspaceV="hyperspace_gate_kpr_M10"
NewShipType.alternativeHyperspaceA="etg/special/SPECIAL_ABILITIES_HYPERSPACE_IN"
NewShipType.alternativeHyperspaceTime=6.5
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"BigCapitalShip, SmallCapitalShip, Frigate, Corvette, Fighter, Mothership","CircleStrafe",{Fighter="MoveToTargetAndShoot"},{Corvette="MoveToTargetAndShoot"},{Utility="Frontal"},{Mothership="Frontal_Keeper_vs_Bentus"},{BigCapitalShip="Frontal_Keeper_vs_Bentus"});
