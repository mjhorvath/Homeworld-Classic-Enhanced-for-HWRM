...
NewShipType.displayedName="$10068"
NewShipType.sobDescription="$10069"
NewShipType.maxhealth=600
...
NewShipType.thrusterMaxSpeed=235
NewShipType.mainEngineMaxSpeed=285
...
NewShipType.CombatFamily="Corvette_TuranicStandard"
...
addAbility(NewShipType,"CanAttack",1,0,1,0,0.35,1,"Fighter, Fighter_hw1,,,,,,, Corvette, Corvette_hw1, Frigate, Capturer, Utility, SmallCapitalShip, BigCapitalShip, Mothership","frontal_LightCorvette",
...
LoadSharedModel(NewShipType,"Tur_StandardCorvette");
StartShipWeaponConfig(NewShipType,"Tur_CorvetteGun","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Tur_CorvetteGun","Weapon_Gun1","Weapon_Gun1");
