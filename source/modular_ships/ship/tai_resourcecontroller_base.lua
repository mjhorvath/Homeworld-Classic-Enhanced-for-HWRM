...
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 30000)
...
NewShipType.paradeData="tai_repairer_parade"
NewShipType.mass=200
NewShipType.collisionMultiplier=1
NewShipType.thrusterMaxSpeed=190
NewShipType.mainEngineMaxSpeed=190
NewShipType.rotationMaxSpeed=36
...
setTargetBox(NewShipType, 0, -0.95,-0.35,-0.7, 0.55,0.3,0.7)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=80
NewShipType.layoutBoundY=70
NewShipType.layoutBoundZ=50
NewShipType.layoutCenterX=-10
...
addAbility(NewShipType,"ShipHold",1,125,0,"rallypoint","",70,
{Fighter="36"},
{Corvette="340"},
{Utility="175"});
...
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",1,1.1,300,800,0,4);
end
...
--AddShipMultiplier(NewShipType, "ResourceDropOffRate", "OwnShipsWithinRadius", "Linear", 1.075, 1.075, 2000)
----AddShipMultiplier(NewShipType, "ResourceCapacity", "OwnShipsWithinRadius", "Linear", 1.075, 1.075, 2000)
--AddShipMultiplier(NewShipType, "ResourceCollectionRate", "OwnShipsWithinRadius", "Linear", 1.075, 1.075, 2000)
addCustomCode(NewShipType,"data:ship/Tai_ResourceController/Tai_ResourceController.lua","","","Update_Tai_ResourceController","","Tai_ResourceController",4)
LoadSharedModel(NewShipType,"Tai_ResourceController");
