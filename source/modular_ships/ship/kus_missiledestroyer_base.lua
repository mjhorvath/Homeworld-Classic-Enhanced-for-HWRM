...
NewShipType.displayedName="$10036"
NewShipType.sobDescription="$10037"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 106000)
NewShipType.regentime=1850
NewShipType.minRegenTime=1850
...
NewShipType.thrusterMaxSpeed=145
NewShipType.mainEngineMaxSpeed=145
...
setSupplyValue(NewShipType, "MissileDestroyer", 1.0)
...
NewShipType.buildCost=2500
NewShipType.buildTime=160
...
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",1,2.2,400,1200,0,4);
end
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1.5,"Corvette_hw1, Corvette, Fighter_hw1, Fighter, Utility,,,,,, Frigate, SmallCapitalShip, BigCapitalShip, Mothership","Frontal",
{Fighter="Frontal"},
{Fighter_hw1="Frontal"},
{Corvette="Frontal"},
{Corvette_hw1="Frontal"},
...
addAbility(NewShipType,"CanBeCaptured",90,0.1,"CapCap");
...
addAbility(NewShipType, "SpecialAttack", 1, "MissileVolley")
--addAbility(NewShipType,"CustomCommand",1,"Missile Volley",1,0,1000,0,6,3,0,"data:Ship/Kus_MissileDestroyer/Kus_MissileDestroyer.lua","Start_Kus_MissileDestroyer","Do_Kus_MissileDestroyer","Finish_Kus_MissileDestroyer","Kus_MissileDestroyer",2,4,1)
addCustomCode(NewShipType,"data:Ship/Kus_MissileDestroyer/Kus_MissileDestroyer.lua","","Create_Kus_MissileDestroyer","Update_Kus_MissileDestroyer","Destroy_Kus_MissileDestroyer","Kus_MissileDestroyer",2)
LoadSharedModel(NewShipType,"Kus_MissileDestroyer");
--StartShipHardPointConfig(NewShipType,"MissileBay","Hardpoint_MissileBay","System","Innate","Damageable","HW1_MissileBay","","","","","","","","");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncher","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncher","Weapon_Gun1","Weapon_Gun1");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncher","Weapon_Gun2","Weapon_Gun2");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncher","Weapon_Gun3","Weapon_Gun3");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncherVolley","Weapon_GunV0","Weapon_Gun0v");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncherVolley","Weapon_GunV1","Weapon_Gun1v");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncherVolley","Weapon_GunV2","Weapon_Gun2v");
StartShipWeaponConfig(NewShipType,"Kus_DestroyerLauncherVolley","Weapon_GunV3","Weapon_Gun3v");
addShield(NewShipType,"EMP",1000,20);
StartShipHardPointConfig(NewShipType,"Engine","Hardpoint_Engine","System","Innate","Damageable","Kus_MissileDestroyerEngine","","","","","","","","");
...
loadLatchPointList(NewShipType,"CapCap","CapturePoint1","CapturePoint2");	
loadLatchPointList(NewShipType,"RepCap","RepairPoint1","RepairPoint2","RepairPoint3","RepairPoint4");		
...
NewShipType.explosiveScuttleDamageOnDeath=1560
NewShipType.maxFalloffForce=500*10
NewShipType.explosiveDamageOnDeath=312														 
