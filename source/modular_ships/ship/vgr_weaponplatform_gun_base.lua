...
NewShipType.displayedName="$1656"
NewShipType.sobDescription="$1657"
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Capturer, Frigate, Utility,Resource,,,,, SmallCapitalShip, BigCapitalShip","justshootVgrPlatform");
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
LoadSharedModel(NewShipType,"Vgr_WeaponPlatform_Gun");
StartShipHardPointConfig(NewShipType,"Weapon_Gun_R","Hardpoint_Gun_R","Weapon","Innate","Ship","Vgr_VulcanKineticTurretLongRange","","","","","","","","");
StartShipHardPointConfig(NewShipType,"Weapon_Gun_L","Hardpoint_Gun_L","Weapon","Innate","Ship","Vgr_VulcanKineticTurretLongRange","","","","","","","","");
--StartShipWeaponConfig(NewShipType,"Vgr_VulcanKineticTurretLongRange","Weapon_Gun_R","Weapon_Gun_R");
--StartShipWeaponConfig(NewShipType,"Vgr_VulcanKineticTurretLongRange","Weapon_Gun_L","Weapon_Gun_L");
