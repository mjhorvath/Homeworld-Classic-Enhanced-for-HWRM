...
NewShipType.displayedName="$10002"
NewShipType.sobDescription="$10003"
...
NewShipType.thrusterMaxSpeed=487
...
NewShipType.antiFrigateValue=0.2
...
addAbility(NewShipType,"CanAttack",1,0,1,0,0.35,1,"Fighter_hw1, Fighter, Swarmer, Corvette_hw1, Corvette, Frigate, Utility, Resource,,,, SmallCapitalShip, BigCapitalShip, Mothership","Fighter_vs_Frigate",
{Fighter="HW1Fighter_vs_HW2Fighter"},
{Fighter_hw1="HW1Fighter_vs_Fighter"},
{Swarmer="HW1Fighter_vs_Fighter"},
...
LoadSharedModel(NewShipType,"Kus_Interceptor");
StartShipWeaponConfig(NewShipType,"Kus_Interceptor","Weapon_Gun1","Weapon_Gun1");
...
setEngineTrail(NewShipType,0,3.86,"trail_ribbon.tga",0.001,0.5,0.025,1.25);
