...
NewShipType.displayedName="$1526"
NewShipType.sobDescription="$1527"
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 22000)
NewShipType.regentime=1100
NewShipType.minRegenTime=1100
...
setTargetBox(NewShipType, 0, -0.5,0.06,-0.72, 0.51,0.77,0.7)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=40
NewShipType.layoutBoundY=45
...
setSupplyValue(NewShipType, "DefenseFieldFrigate", 1.0)
...
NewShipType.buildPriorityOrder=25
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1","JustShoot");
addAbility(NewShipType,"GuardCommand",1,2000,300);
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
addAbility(NewShipType,"CanBeCaptured",45,0.5,"CapCap");
...
addCustomCode(NewShipType,"data:ship/Hgn_DefenseFieldFrigate/Hgn_DefenseFieldFrigate.lua","","","Update_Hgn_DefenseFieldFrigate","","Hgn_DefenseFieldFrigate",4)
LoadSharedModel(NewShipType,"Hgn_DefenseFieldFrigate");
StartShipHardPointConfig(NewShipType,"Weapon_Top","Hardpoint_Top","Weapon","Innate","Ship","Hgn_VulcanKineticTurretHeavy","","","","","","","","");
