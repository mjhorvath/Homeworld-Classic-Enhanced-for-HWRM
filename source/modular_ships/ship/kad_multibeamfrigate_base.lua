...
NewShipType.rotationMaxSpeed=42
...
LoadSharedModel(NewShipType,"Kad_MultiBeamFrigate");
...
addCustomCode(NewShipType,"data:ship/Kad_MultiBeamFrigate/Kad_MultiBeamFrigate.lua","","","updateKad_MultiBeamFrigate","","Kad_MultiBeamFrigate",1.25)
