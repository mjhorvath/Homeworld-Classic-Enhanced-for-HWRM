...
NewShipType.displayedName="$10022"
NewShipType.sobDescription="$10023"
...
NewShipType.mass=20
NewShipType.collisionMultiplier=0.45
NewShipType.thrusterMaxSpeed=320
NewShipType.mainEngineMaxSpeed=320
NewShipType.rotationMaxSpeed=170
NewShipType.thrusterAccelTime=2.0
NewShipType.thrusterBrakeTime=1
NewShipType.mainEngineAccelTime=2.0
...
NewShipType.buildCost=175
NewShipType.buildTime=16
NewShipType.buildPriorityOrder=60
...
addAbility(NewShipType,"CanAttack",1,3,1,1,0.35,1,"Fighter_hw1, Fighter, Swarmer, Corvette_hw1, Corvette, Capturer, Frigate, Utility, SmallCapitalShip, BigCapitalShip","frontal_LightCorvette",
...
addAbility(NewShipType,"RepairCommand",1,250,1,1,"Frontal_RepairCorvette",
{Flagship=2.0},
{SuperCap=2.0}, 
{BattleCruiser=2.0}, 
{Carrier=1.5},  
...
--addCustomCode(NewShipType,"data:Ship/Tai_RepairCorvette/Tai_RepairCorvette.lua","","Create_Tai_RepairCorvette","Update_Tai_RepairCorvette","Destroy_Tai_RepairCorvette","Tai_RepairCorvette",15)
LoadSharedModel(NewShipType,"Tai_RepairCorvette");
StartShipWeaponConfig(NewShipType,"Tai_RepairGun","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Tai_RepairGunHeal","Weapon_Rep0","Weapon_Rep0");
...
setEngineTrail(NewShipType,0,3.2,"trail_ribbon.tga",0.01,0.2,0.025,2.45);
