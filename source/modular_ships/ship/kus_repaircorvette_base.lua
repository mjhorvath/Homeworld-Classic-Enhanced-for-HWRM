...
LoadSharedModel(NewShipType,"Kus_RepairCorvette");
StartShipWeaponConfig(NewShipType,"Kus_RepairGun","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Kus_RepairGunHeal","Weapon_Rep0","Weapon_Rep0");
...
setEngineTrail(NewShipType,0,3.2,"trail_ribbon.tga",0.01,0.2,0.025,5);
