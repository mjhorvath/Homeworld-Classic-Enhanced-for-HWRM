...
NewShipType.regentime=7467
NewShipType.minRegenTime=7467
...
NewShipType.paradeData="kad_mothership_parade"
NewShipType.mass=2000
NewShipType.collisionMultiplier=1
NewShipType.thrusterMaxSpeed=53
NewShipType.mainEngineMaxSpeed=53
...
setTargetBox(NewShipType, 0, -0.04	,-0.04,-0.9, 0.04,0.04,1)
NewShipType.useLayoutBounds=1
NewShipType.layoutBoundX=600
NewShipType.layoutBoundY=320
...
NewShipType.BuildFamily="Flagship_Kad"
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Utility, Mothership","Frontal",
...
addAbility(NewShipType,"CanBuildShips",1,"Fighter_Kad, Corvette_Kad, Frigate_Kad, Utility_Kad","Utility, Fighter, Corvette, Frigate, Capital");
addAbility(NewShipType,"CanBeRepaired");
addAbility(NewShipType,"RetireAbility",1,0);
LoadSharedModel(NewShipType,"Kad_P2Mothership");
StartShipWeaponConfig(NewShipType,"Kad_MothershipIon","Weapon_Gun0","Weapon_Gun0");
StartShipWeaponConfig(NewShipType,"Kad_MothershipIon","Weapon_Gun1","Weapon_Gun1");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun2","Weapon_Gun2");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun3","Weapon_Gun3");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun4","Weapon_Gun4");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun5","Weapon_Gun5");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun6","Weapon_Gun6");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun7","Weapon_Gun7");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun8","Weapon_Gun8");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun9","Weapon_Gun9");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun10","Weapon_Gun10");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun11","Weapon_Gun11");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun12","Weapon_Gun12");
StartShipWeaponConfig(NewShipType,"Kad_MothershipGun","Weapon_Gun13","Weapon_Gun13");
...
setEngineGlow(NewShipType,1,1,1.02,20,450,200,2,{0.95, 0.35, .18, 0.10});
