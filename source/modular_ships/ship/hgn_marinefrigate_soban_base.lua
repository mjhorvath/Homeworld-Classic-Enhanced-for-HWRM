...
NewShipType.displayedName="$1566"
NewShipType.sobDescription="$1567"
...
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1.5,"Capturer, Corvette, Fighter, SmallCapitalShip, BigCapitalShip, Mothership","Frontal",{Fighter="MoveToTargetAndShoot"},{Corvette="MoveToTargetAndShoot"},{Munition="MoveToTargetAndShoot"},{SubSystem="FrontalVsSubSystem"});
...
StartShipHardPointConfig(NewShipType,"Weapon_Top","Hardpoint_Top","Weapon","Innate","Ship","Hgn_VulcanKineticTurretSuperHeavy","","","","","","","","");
--StartShipWeaponConfig(NewShipType,"Hgn_VulcanKineticTurretSuperHeavy","Weapon_Top","Weapon_Top");
