...
if hypBool == 1 then
	addAbility(NewShipType,"HyperSpaceCommand",0,1,300,500,0,3);
end
addAbility(NewShipType,"CanAttack",1,1,0,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Frigate, Utility, SmallCapitalShip, BigCapitalShip, Mothership","JustShoot");
...
addCustomCode(NewShipType,"data:ship/Hgn_ResourceController/Hgn_ResourceController.lua","","","Update_Hgn_ResourceController","","Hgn_ResourceController",4)
LoadSharedModel(NewShipType,"Hgn_ResourceController");
StartShipWeaponConfig(NewShipType,"Hw2_MobGun","Weapon_HullDefense1","Weapon_HullDefense1");
StartShipWeaponConfig(NewShipType,"Hw2_MobGun","Weapon_HullDefense3","Weapon_HullDefense3");
StartShipWeaponConfig(NewShipType,"Hw2_MobGun","Weapon_HullDefense5","Weapon_HullDefense5");
StartShipWeaponConfig(NewShipType,"Hw2_MobGun","Weapon_HullDefense8","Weapon_HullDefense8");
