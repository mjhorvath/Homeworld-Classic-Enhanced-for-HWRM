...
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 14000)
NewShipType.regentime=1600
NewShipType.minRegenTime=1600
...
setTargetBox(NewShipType, 0, -0.21,-0.48,-0.8, 0.67,0.8,0.8)
...
addAbility(NewShipType,"CanAttack",1,1,0,1,0.35,1.5,"Corvette, Corvette_hw1, Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Utility,,,,,, Fighter, Fighter_hw1","frontal_frigate",
{Fighter="MoveToTargetAndShoot"},
{Fighter_hw1="MoveToTargetAndShoot"},
{Corvette="movetotargetandshoot_Torps_vs_Corvettes"},
{Corvette_hw1="movetotargetandshoot_Torps_vs_Corvettes"},
...
addCustomCode(NewShipType,"data:ship/Hgn_TorpedoFrigate/Hgn_TorpedoFrigate.lua","","","Update_Hgn_TorpedoFrigate","","Hgn_TorpedoFrigate",4)
LoadSharedModel(NewShipType,"Hgn_TorpedoFrigate");
