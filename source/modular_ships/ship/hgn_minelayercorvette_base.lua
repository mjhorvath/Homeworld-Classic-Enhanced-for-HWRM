...
NewShipType.displayedName="$1510"
NewShipType.sobDescription="$1511"
...
NewShipType.mass=15
NewShipType.collisionMultiplier=0.48
...
addAbility(NewShipType,"CanAttack",1,1,1,0,0.35,1,"Munition, BigCapitalShip, SmallCapitalShip, Frigate, Corvette, Corvette_hw1, Fighter, Fighter_hw1, Utility","FlyRound_MinelayerCorvette_vs_Frigate",
{Fighter="FlyRound_MinelayerCorvette_vs_Fighter"},
{Fighter_hw1="FlyRound_MinelayerCorvette_vs_Fighter"},
{Mothership="flyround_MinelayerCorvette_vs_Mothership"},
{SmallCapitalShip="FlyRound_MinelayerCorvette_vs_CapShip"},
{BigCapitalShip="FlyRound_MinelayerCorvette_vs_CapShip"},
{SubSystem="FrontalVsSubSystem_Corvette"},
{Corvette="Corvette_vs_Corvette_AR"},
{Corvette_hw1="Corvette_vs_Corvette_AR"},
...
LoadSharedModel(NewShipType,"Hgn_MinelayerCorvette");
StartShipHardPointConfig(NewShipType,"Weapon_TurretBottom","Hardpoint_TurretBottom","Weapon","Innate","Ship","Hgn_MinelayerKineticTurret","","","","","","","","");
...
setEngineTrail(NewShipType,0,5,"trail_ribbon.tga",0.001,0.2,0.025,2);
setEngineTrail(NewShipType,1,5,"trail_ribbon.tga",0.001,0.2,0.025,2);
