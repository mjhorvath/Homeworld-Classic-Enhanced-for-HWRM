...
NewShipType.displayedName="$1602"
NewShipType.sobDescription="$1603"
...
NewShipType.buildBatch=getShipNum(NewShipType, "buildBatch", 7)
...
NewShipType.holdSlots=1.4
NewShipType.mass=10
NewShipType.collisionMultiplier=0.35
NewShipType.thrusterMaxSpeed=348
NewShipType.mainEngineMaxSpeed=348
...
NewShipType.accelerationAngle=47
NewShipType.mirrorAngle=30
NewShipType.secondaryTurnAngle=47
...
setSupplyValue(NewShipType, "Interceptor", 5.0)
setSupplyValue(NewShipType, "LayoutFighter", 5.0)
NewShipType.fighterValue=1.14
NewShipType.corvetteValue=0
NewShipType.frigateValue=0
NewShipType.neutralValue=0
NewShipType.antiFighterValue=1.14
NewShipType.antiCorvetteValue=0
NewShipType.antiFrigateValue=0
NewShipType.totalValue=1.14
...
addAbility(NewShipType,"CanAttack",1,2,1,0,0.35,1,"Fighter, Fighter_hw1, Corvette, Corvette_hw1, Frigate, Utility,Resource,,,,, SmallCapitalShip, BigCapitalShip, Mothership","Fighter_vs_Frigate",
...
addCustomCode(NewShipType, "data:ship/Vgr_Interceptor/Vgr_Interceptor.lua", "", "", "Update_Vgr_Interceptor", "", "Vgr_Interceptor", 1)
LoadSharedModel(NewShipType,"Vgr_Interceptor");
