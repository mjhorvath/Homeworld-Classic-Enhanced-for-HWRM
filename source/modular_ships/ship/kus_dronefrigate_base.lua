...
addAbility(NewShipType,"CanAttack",1,1,0,1,0.35,1.5,"Fighter_hw1, Fighter, Swarmer, Corvette_hw1, Corvette,,,,,, Capturer, Frigate, SmallCapitalShip, BigCapitalShip, Utility","frontal_Frigate",
{Fighter="MoveToTargetAndShoot_Frigate"},
{Fighter_hw1="MoveToTargetAndShoot_Frigate"},
{Swarmer="movetotargetandshoot_Frigate"},
...
addAbility(NewShipType,"CustomCommand",1,"Drones",1,0,99999,1.2,0.01,1000,0,"data:Ship/Kus_DroneFrigate/Kus_DroneFrigate.lua","Start_DroneFrigate","Do_DroneFrigate","Finish_DroneFrigate","Kus_DroneFrigate",0.1,2,1)
...
LoadSharedModel(NewShipType,"Kus_DroneFrigate");
