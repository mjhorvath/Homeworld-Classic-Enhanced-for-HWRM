...
NewShipType.displayedName="$10010"
NewShipType.sobDescription="$10011"
...
NewShipType.thrusterMaxSpeed=430*0.77
NewShipType.mainEngineMaxSpeed=487
...
NewShipType.mirrorAboveManeuver="ImmelMann_speedy, ImmelMann_speedy, ImmelMann_speedy, ImmelMann_speedy"
NewShipType.mirrorBelowManeuver="ImmelMann_speedy, ImmelMann_speedy, ImmelMann_speedy, ImmelMann_speedy"
...
setSupplyValue(NewShipType, "DefenseFighters", 1.0)
setSupplyValue(NewShipType, "LayoutFighter", 1.0)
NewShipType.CombatFamily="Fighter_Special"
...
addAbility(NewShipType,"CanAttack",1,1,1,0,0.35,1,"SpaceMine,Torpedo,HeavyMissile,SmallMissile,Munition","flyround_defensefighter");
addAbility(NewShipType,"GuardCommand",1,500,100);
if hypBool == 1 then
	addAbility(NewShipType,"HyperspaceViaGateCommand",1,3,1,0.3);
end
addAbility(NewShipType,"RetireAbility",1,0);
addMagneticField(NewShipType,"MagneticField",600,100,"defenseField_generic",85,"defenseField_generic",100,"plasma_hit_spray_MagneticField","defensefield_sphere_spray_DF");
AddShipMultiplier(NewShipType,"WeaponAccuracy","EnemyShipsWithinRadius","Linear",0.99,0.99,700);
addCustomCode(NewShipType,"data:ship/Tai_DefenseFighter/Tai_DefenseFighter.lua","","","updateDefenseFighter","","DefenseFighter",1.25)
LoadSharedModel(NewShipType,"Tai_DefenseFighter");
StartShipWeaponConfig(NewShipType,"Tai_DefenseLaser","Weapon_Gun0","");
...
setEngineTrail(NewShipType,0,1.6,"trail_ribbon.tga",0.01,0.5,0.025,1.25);
