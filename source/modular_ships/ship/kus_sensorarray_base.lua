...
NewShipType.maxhealth=getShipNum(NewShipType, "maxhealth", 5500)
...
setTargetBox(NewShipType, 0, -0.3,-0.5,-0.3, 0.3,0.4,0.3)
...
addCustomCode(NewShipType,"data:Ship/Kus_SensorArray/Kus_SensorArray.lua","","","Update_Kus_SensorArray","","Kus_SensorArray",10)
...
NewShipType.explosiveScuttleDamageOnDeath=206
NewShipType.maxFalloffForce=500*10
NewShipType.explosiveDamageOnDeath=41
