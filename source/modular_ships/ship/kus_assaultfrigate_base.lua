...
addCustomCode(NewShipType,"data:ship/Kus_AssaultFrigate/Kus_AssaultFrigate.lua","","","Update_Kus_AssaultFrigate","","Kus_AssaultFrigate",4)
LoadSharedModel(NewShipType,"Kus_AssaultFrigate");
