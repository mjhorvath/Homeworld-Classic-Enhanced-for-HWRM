...
--  { 138, "MainUI_UserEvent( eRallyPoint)",		 										INKE_KeyDown, 0, 	"   $5424", 		{ PKEY } },
	...
	{ 251, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'BountiesScreen', 0, gr_all)",			INKE_KeyDown, 0, 	"Bounties",	 		{ PKEY } },	-- P
	{ 252, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'BentusiScreen', 0, gr_all)",				INKE_KeyDown, 0, 	"Bentusi Roulette", 		{ 186 } },	-- semicolon
	{ 253, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'ProgressScreen', 0, gr_all)",			INKE_KeyDown, 0, 	"Team Progress Meter", 		{ LESSTHAN } },	-- comma
	{ 254, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'MusicScreen', 0, gr_all)",				INKE_KeyDown, 0, 	"Audio Track History", 		{ MINUSKEY } },	-- minus
	{ 255, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'RulesScreen', 0, gr_all)",				INKE_KeyDown, 0, 	"Game Rules List", 		{ PLUSKEY } },	-- plus
}
