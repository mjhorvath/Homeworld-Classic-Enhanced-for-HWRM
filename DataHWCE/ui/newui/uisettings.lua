...
GameScreens = {
	...
	{
		name = "BountiesScreen",
		filename = "DATA:\\UI\\NewUI\\BountiesScreen.lua",
		activated = 0,
	},
	{
		name = "BentusiScreen",
		filename = "DATA:\\UI\\NewUI\\BentusiScreen.lua",
		activated = 0,
	},
	{
		name = "ProgressScreen",
		filename = "DATA:\\UI\\NewUI\\ProgressScreen.lua",
		activated = 0,
	},
	{
		name = "MusicScreen",
		filename = "DATA:\\UI\\NewUI\\MusicScreen.lua",
		activated = 0,
	},
	{
		name = "RulesScreen",
		filename = "DATA:\\UI\\NewUI\\RulesScreen.lua",
		activated = 0,
	},
	-- end HWCE screens
	{
