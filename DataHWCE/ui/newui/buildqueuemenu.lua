...
BuildQueueMenu = {
	...
	onShow = "UI_SetButtonPressed('NewTaskbar', 'btnQueue', 1); UI_HideScreen('UnitCapInfoPopup'); UI_HideScreen('EventsScreen'); UI_HideScreen('BountiesScreen'); UI_HideScreen('BentusiScreen'); UI_HideScreen('ProgressScreen'); UI_HideScreen('MusicScreen'); UI_HideScreen('RulesScreen');",
