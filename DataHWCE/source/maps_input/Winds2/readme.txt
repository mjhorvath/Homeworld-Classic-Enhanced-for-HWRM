...
Installing
	...
	Simply unzip the "Winds2" folder to your "HomeWorld/Multiplayer/" directory and it will appear in all mulitplayer modes.

-----

Notes from the author

	This looks look a long fight. Show your opponent that looks can be deceiving. If it does go past the mid game, there are 3 asteroid fields that regenrate on this one, so don't give up if you lose the center patch for awhile.
