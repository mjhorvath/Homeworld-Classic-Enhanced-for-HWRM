...
-- HWCE Hacks
	...
	-- needed because it normally requires an advanced research module, and adv. research modules were eliminated to balance versus the vaygr research module
	{
		Type = SubSystem,
		ThingToBuild = "Hgn_C_Module_FireControl_research0",
		RequiredResearch = "",
		RequiredFleetSubSystems = "Research",
		DisplayPriority = 60,
		DisplayedName = "$7020",
	...
	{
		Type = SubSystem,
		ThingToBuild = "Hgn_MS_Module_FireControl_research0",
		RequiredResearch = "",
		RequiredFleetSubSystems = "Research",
		DisplayPriority = 60,
		DisplayedName = "$7020",
	...
	{
		Type = Ship,
		ThingToBuild = "Hgn_Carrier_research0",
		RequiredResearch = "",
		RequiredShipSubSystems = "CapShipProduction",
		DisplayPriority = 110,
		DisplayedName = "$7054",
	...
	{
		Type = Ship,
		ThingToBuild = "Hgn_Battlecruiser_research0",
		RequiredResearch = "BattlecruiserIonWeapons",
		RequiredShipSubSystems = "CapShipProduction",
		DisplayPriority = 118,
		DisplayedName = "$7060",
