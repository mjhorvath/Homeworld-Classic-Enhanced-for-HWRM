...
function oninit()
	StartWithMode = Rules_GetSettingString("startwith", "mothership")
	ResearchMode = Rules_GetSettingNumber("research", 1)
	ResourceMode = Rules_GetSettingNumber("resstart", 1000)
	HyperspaceMode = Rules_GetSettingNumber("hyperspace", 1)
	ModeSuffixTable = {StartWithMode == "carrieronly", ResearchMode == 1, ResourceMode ~= -1, HyperspaceMode == 1,}
	print("SETTINGS: car " .. StartWithMode .. "; rch " .. ResearchMode .. "; res " .. ResourceMode .. "; hyp " .. HyperspaceMode)
end
