...
function HW1CPUBuildControl(bOn)
    AI_trace("HW1CPUBuildControl: "..bOn)
	sg_dobuild = bOn
	sg_dosubsystems = bOn
	sg_doresearch = bOn
	sg_doupgrades = bOn
...
function HW1CPUTacticalControl(bOn)
    AI_trace("HW1CPUTacticalControl: "..bOn)
    sg_domilitary = bOn
...
function HW1CPUEnableResourceFeature(feature, bOn)
    AI_trace("HW1CPUEnableResourceFeature: "..feature)
    ...
    elseif (feature == AIR_AGGRESSIVE_RESOURCING) then
        ...
        AI_trace("HW1CPUEnableResourceFeature: don't know how to ENABLE unsupported feature "..feature)
    end
end
function HW1CPUEnableDefenseFeature(feature, bOn)
    AI_trace("HW1CPUEnableDefenseFeature: "..feature)
    ...
    elseif (feature == AID_CLOAK_DEFENSE_RED) then
        ...
        AI_trace("HW1CPUEnableDefenseFeature: don't know how to ENABLE unsupported feature "..feature)
    end
end
function HW1CPUEnableAttackFeature(feature, bOn)
    AI_trace("HW1CPUEnableAttackFeature: "..feature)
    if (feature == AIA_ACTIVE_RECONAISSANCE) then
        sg_activeReconaissance = bOn
    else
        AI_trace("HW1CPUEnableAttackFeature: don't know how to ENABLE unsupported feature "..feature)
    end
end
function HW1CPUEnableTeamFeature(feature, bOn)
    AI_trace("HW1CPUEnableTeamFeature: "..feature)
    if (feature == AIT_ADVANCED_ATTACK) then
        sg_advancedAttack = bOn
    elseif (feature == AIT_FLANK_ATTACK) then
        sg_flankAttack = bOn
    else
        AI_trace("HW1CPUEnableTeamFeature: don't know how to ENABLE unsupported feature "..feature)
    end
end
...
function HW1CPUEnableAIFeature(feature, type)
    AI_trace("HW1CPUEnableAIFeature: "..feature..", "..type)
...
function HW1CPUDisableAIFeature(feature, type)
    AI_trace("HW1CPUDisableAIFeature: "..feature..", "..type)
...
function HW1CPUDisableAllAIFeatures()
    AI_trace("HW1CPUDisableAllAIFeatures")
...
function HW1CPUEnableAllAIFeatures()
    AI_trace("HW1CPUEnableAllAIFeatures")
...
function HW1CPUTeamGiveToAI(teamName)
    AI_trace("HW1CPUTeamGiveToAI: "..teamName)
end
