...
function Create_Kus_Carrier(CustomGroup, playerIndex, shipID) 	
	...
	if Player_GetNumberOfVariantSquadronsOfTypeAwakeOrSleeping(playerIndex, "kus_mothership") == 0 then
...
function Update_Kus_Carrier(CustomGroup, playerIndex, shipID)
	...
	-- I did not create any variants of the research ship for HWCE, so the code remains okay - mikali
	for i = 0,5,1 do
