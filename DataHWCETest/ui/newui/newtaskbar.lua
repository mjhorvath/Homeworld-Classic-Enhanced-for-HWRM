...
NewTaskbar = {	
	...
	----------------------------- Left Side Handy Buttons --------------------------
	{
		...
		Layout = {	
			pivot_XY = { 0.0, 0.0 },
			size_WH = { w = 60, h = 360, wr = "px", hr = "px" },
		},	
		--name = "frame_LeftTabs",
		arrangetype = "vert",
		...
		},
		{
			...
			-------------------------- Homeworld Classic Enhanced Handy Buttons --------------------------
			...
			-- Bounties button
			{
				...
				ignored = 1,
				buttonStyle = "RM_TaskbarHD_CommandButtonToggleStyle",
				onMouseClicked = "UI_ToggleScreen( 'BountiesScreen', 0)",	
				helpTip = "BOUNTIES (P)",
				helpTipTextLabel = "commandsHelpTip",
				hotKeyID = 251,
				soundOnClicked = "SFX_ButtonClick",
				...
				BackgroundGraphic = {
					--size = {4, 4},
					texture = "DATA:UI\\NewUI\\Taskbar\\HudIcons\\hud_bounties.tga",
					uvRect = { 0/128, 0/1024, 128/128, 128/1024 },
					patch_X = { 4,-120,4,0 },
					patch_Y = { 4,-120,4,0 },
					patch_Scale = 1,
			...
			-- Bentusi Roulette button
			{
				...
				ignored = 1,
				buttonStyle = "RM_TaskbarHD_CommandButtonToggleStyle",
				onMouseClicked = "UI_ToggleScreen( 'BentusiScreen', 0)",	
				helpTip = "BENTUSI ROULETTE (SEMICOLON)",
				helpTipTextLabel = "commandsHelpTip",
				hotKeyID = 252,
				soundOnClicked = "SFX_ButtonClick",
				...
				BackgroundGraphic = {
					--size = {4, 4},
					texture = "DATA:UI\\NewUI\\Taskbar\\HudIcons\\hud_bentusi.tga",
					uvRect = { 0/128, 0/1024, 128/128, 128/1024 },
					patch_X = { 4,-120,4,0 },
					patch_Y = { 4,-120,4,0 },
					patch_Scale = 1,
			...
			-- Team Progress Meter button
			{
				...
				ignored = 1,
				buttonStyle = "RM_TaskbarHD_CommandButtonToggleStyle",
				onMouseClicked = "UI_ToggleScreen( 'ProgressScreen', 0)",	
				helpTip = "TEAM PROGRESS (COMMA)",
				helpTipTextLabel = "commandsHelpTip",
				hotKeyID = 253,
				soundOnClicked = "SFX_ButtonClick",
				...
				BackgroundGraphic = {
					--size = {4, 4},
					texture = "DATA:UI\\NewUI\\Taskbar\\HudIcons\\hud_progress.tga",
					uvRect = { 0/128, 0/1024, 128/128, 128/1024 },
					patch_X = { 4,-120,4,0 },
					patch_Y = { 4,-120,4,0 },
					patch_Scale = 1,
			...
			-- Audio Track History button
			{
				...
				ignored = 1,
				buttonStyle = "RM_TaskbarHD_CommandButtonToggleStyle",
				onMouseClicked = "UI_ToggleScreen( 'MusicScreen', 0)",	
				helpTip = "TRACK HISTORY (MINUS)",
				helpTipTextLabel = "commandsHelpTip",
				hotKeyID = 254,
				soundOnClicked = "SFX_ButtonClick",
				...
				BackgroundGraphic = {
					--size = {4, 4},
					texture = "DATA:UI\\NewUI\\Taskbar\\HudIcons\\hud_music.tga",
					uvRect = { 0/128, 0/1024, 128/128, 128/1024 },
					patch_X = { 4,-120,4,0 },
					patch_Y = { 4,-120,4,0 },
					patch_Scale = 1,
			...
			-- Game Rules List button
			{
				...
				ignored = 1,
				buttonStyle = "RM_TaskbarHD_CommandButtonToggleStyle",
				onMouseClicked = "UI_ToggleScreen( 'RulesScreen', 0)",	
				helpTip = "GAME RULES (EQUALS)",
				helpTipTextLabel = "commandsHelpTip",
				hotKeyID = 255,
				soundOnClicked = "SFX_ButtonClick",
				...
				BackgroundGraphic = {
					--size = {4, 4},
					texture = "DATA:UI\\NewUI\\Taskbar\\HudIcons\\hud_rules.tga",
					uvRect = { 0/128, 0/1024, 128/128, 128/1024 },
					patch_X = { 4,-120,4,0 },
					patch_Y = { 4,-120,4,0 },
					patch_Scale = 1,
