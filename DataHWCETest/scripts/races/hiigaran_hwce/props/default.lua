...
-- not sure which of these are still required
Number_Properties =
{
...
String_Properties =
{
	...
	path_build = [[data:scripts/races/hiigaran_hwce/scripts/def_build.lua]],
	path_research = [[data:scripts/races/hiigaran_hwce/scripts/def_research.lua]],
	-- doesn't exist AFAIK
	path_ai = [[data:scripts/races/hiigaran_hwce/scripts/def_ai.lua]],
...
--	path_ai_build = [[data:scripts/races/hiigaran_hwce/scripts/ai_build.lua]],
	path_ai_special = [[data:scripts/races/hiigaran_hwce/scripts/ai_special.blank.lua]],
	path_ai_research = [[data:scripts/races/hiigaran_hwce/scripts/ai_upgrades.blank.lua]],
	path_ai_subsystems = [[data:scripts/races/hiigaran_hwce/scripts/ai_subsystems.blank.lua]],
	path_ai_build = [[data:scripts/races/hiigaran_hwce/scripts/ai_build.blank.lua]],

	-- these should not be required anymore AFAIK
