...
String_Properties = {
	...
	path_build = [[data:scripts/races/kushan_hwce/scripts/def_build.lua]],
	path_research = [[data:scripts/races/kushan_hwce/scripts/def_research.lua]],
	path_ai = [[data:scripts/races/kushan_hwce/scripts/def_ai.lua]],		-- doesn't exist

	path_ai_special = [[data:scripts/races/kushan_hwce/scripts/ai_special.lua]],
	path_ai_research = [[data:scripts/races/kushan_hwce/scripts/ai_upgrades.lua]],
	path_ai_build = [[data:scripts/races/kushan_hwce/scripts/ai_build.lua]],

	-- these should not be required anymore
--	path_crate_locate = [[data:scripts/races/kushan_hwce/scripts/crate_locate.lua]],
--	path_crate_ships = [[data:scripts/races/kushan_hwce/scripts/crate_ships.lua]],
