		...
		{
			{
				...
				items =
				{
					...
					{types = {"HyperspaceCostUpgrade1"}, name = "Improved Hyperspace Drive 1", prob = 4/4, cost = 1000,},
				},
			},
			{
				class = "cruiser",
		...
		ships =
		{
			...
			},
			{
				...
				items =
				{
					...
					{types = {"Vgr_Carrier_car1"}, name = "Carrier", prob = 0, cost = 1700,},
				},
			},
			{
				class = "destroyer",
