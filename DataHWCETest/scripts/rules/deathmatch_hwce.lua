...
GameRulesName		= "HWC Enhanced 3.0.0"
...
ExtFilter			= "rules_dm_hwce"
Race_Paths			= "deathmatch_hwce"
Level_Pass_Tags		= "levels_dm_hwce"
...
function createtracktable()
	...
	for trackindex = 1, TracksNumber do
		...
		temptable[indexcount - 1] = TracksList[trackindex][1]
...
-- have to disable either the Special Fleets or Defined Roles game modes.
GameSetupOptions =
{
	----------------------------------------------------------------------------
	...
	-- 3. starting resource option	-- to localize
	{
		name = "resstart",
		locName = "$3205",
		tooltip = "$3232",
...
dofilepath("data:scripts/rules/deathmatch_hwce/deathmatch_hwce.lua")
